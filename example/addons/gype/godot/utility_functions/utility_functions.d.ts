declare global {
    declare class UtilityFunctions {
        ...
        type_of(_variable: any): number;
        type_convert(_variant: any, _type: number): any;
        str(_arg1: any): String;
        error_string(_error: number): String;
        type_string(_type: number): String;
        print(_arg1: any): void;
        print_rich(_arg1: any): void;
        printerr(_arg1: any): void;
        printt(_arg1: any): void;
        prints(_arg1: any): void;
        printraw(_arg1: any): void;
        print_verbose(_arg1: any): void;
        push_error(_arg1: any): void;
        push_warning(_arg1: any): void;
        var_to_str(_variable: any): String;
        str_to_var(_string: String): any;
        ...
        instance_from_id(_instance_id: number): Object;

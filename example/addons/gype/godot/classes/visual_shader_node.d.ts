...
export declare class VisualShaderNode extends Resource{
  ...
  public set_input_port_default_value(_port: number, _value: Variant, _prev_value: Variant): void;
  public get_input_port_default_value(_port: number): Variant;
  ...
  public set output_port_for_preview(value: number): void {
    set_output_port_for_preview(value);
  }
  public get default_input_values(): Array {
    get_default_input_values();
  }
  public set default_input_values(value: Array): void {
    set_default_input_values(value);
  }
  public get expanded_output_ports(): Array {
    _get_output_ports_expanded();
  }
  public set expanded_output_ports(value: Array): void {
    _set_output_ports_expanded(value);
  }
  public get linked_parent_graph_frame(): number {
    get_frame();
  }
  public set linked_parent_graph_frame(value: number): void {
    set_frame(value);
  }
  static PortType = {
    PORT_TYPE_SCALAR = 0,

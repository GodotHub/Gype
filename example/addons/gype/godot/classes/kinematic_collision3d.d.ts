...
export declare class KinematicCollision3D extends RefCounted{
  ...
  public get_local_shape(_collision_index: number): GodotObject;
  public get_collider(_collision_index: number): GodotObject;
  public get_collider_id(_collision_index: number): number;
  public get_collider_rid(_collision_index: number): RID;
  public get_collider_shape(_collision_index: number): GodotObject;

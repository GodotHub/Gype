...
export declare class ENetMultiplayerPeer extends MultiplayerPeer{
  ...
  public create_client(_address: GDString | StringName | string, _port: number, _channel_count: number = 0, _in_bandwidth: number = 0, _out_bandwidth: number = 0, _local_port: number = 0): number;
  public create_mesh(_unique_id: number): number;
  public add_mesh_peer(_peer_id: number, _host: ENetConnection): number;
  public set_bind_ip(_ip: GDString | StringName | string): void;

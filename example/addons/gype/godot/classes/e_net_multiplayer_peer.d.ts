...
export declare class ENetMultiplayerPeer extends MultiplayerPeer{
  ...
  public create_client(_address: GDString | StringName | string, _port: number, _channel_count: number, _in_bandwidth: number, _out_bandwidth: number, _local_port: number): number;

...
export declare class GLTFDocument extends Resource{
  ...
  public append_from_file(_path: GDString | StringName | string, _state: GLTFState, _flags: number, _base_path: GDString | StringName | string): number;
  public append_from_buffer(_bytes: PackedByteArray, _base_path: GDString | StringName | string, _state: GLTFState, _flags: number): number;

...
export declare class PhysicsDirectSpaceState2D extends Object{
  public intersect_point(_parameters: PhysicsPointQueryParameters2D, _max_results: number): Array;
  public intersect_ray(_parameters: PhysicsRayQueryParameters2D): Dictionary;
  public intersect_shape(_parameters: PhysicsShapeQueryParameters2D, _max_results: number): Array;
  public cast_motion(_parameters: PhysicsShapeQueryParameters2D): PackedFloat32Array;
  public collide_shape(_parameters: PhysicsShapeQueryParameters2D, _max_results: number): Array;

...
export declare class LightmapGIData extends Resource{
  public set_lightmap_textures(_light_textures: typedarray::TextureLayered): void;
  public get_lightmap_textures(): Array;
  ...
  public get lightmap_textures(): Array {
    get_lightmap_textures();
  }
  public set lightmap_textures(value: Array): void {
    set_lightmap_textures(value);
  }
  public get uses_spherical_harmonics(): boolean {
    is_using_spherical_harmonics();
  }
  public set uses_spherical_harmonics(value: boolean): void {
    set_uses_spherical_harmonics(value);
  }
  public get user_data(): Array {
    _get_user_data();
  }
  public set user_data(value: Array): void {
    _set_user_data(value);
  }
  public get probe_data(): Dictionary {
    _get_probe_data();
  }
  public set probe_data(value: Dictionary): void {
    _set_probe_data(value);
  }
  public get light_texture(): TextureLayered {
    get_light_texture();
  }
  public set light_texture(value: TextureLayered): void {
    set_light_texture(value);
  }
  public get light_textures(): Array {
    _get_light_textures_data();
  }
  public set light_textures(value: Array): void {

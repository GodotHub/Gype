...
export declare class TileSetAtlasSource extends TileSetSource{
  ...
  public create_tile(_atlas_coords: Vector2i, _size: Vector2i = Vector2i(1, 1)): void;
  public remove_tile(_atlas_coords: Vector2i): void;
  public move_tile_in_atlas(_atlas_coords: Vector2i, _new_atlas_coords: Vector2i = Vector2i(-1, -1), _new_size: Vector2i = Vector2i(-1, -1)): void;
  public get_tile_size_in_atlas(_atlas_coords: Vector2i): Vector2i;
  public has_room_for_tile(_atlas_coords: Vector2i, _size: Vector2i, _animation_columns: number, _animation_separation: Vector2i, _frames_count: number, _ignored_tile: Vector2i = Vector2i(-1, -1)): boolean;
  ...
  public create_alternative_tile(_atlas_coords: Vector2i, _alternative_id_override: number = -1): number;
  ...
  public get_tile_texture_region(_atlas_coords: Vector2i, _frame: number = 0): Rect2i;

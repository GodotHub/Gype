...
export declare class NavigationServer2D extends GodotObject{
  ...
  public query_path(_parameters: NavigationPathQueryParameters2D, _result: NavigationPathQueryResult2D): void;
  ...
  public region_owns_point(_region: RID, _point: Vector2): boolean;
  ...
  public region_set_transform(_region: RID, _transform: Transform2D): void;
  public region_get_transform(_region: RID): Transform2D;
  public region_set_navigation_polygon(_region: RID, _navigation_polygon: NavigationPolygon): void;
  public region_get_connections_count(_region: RID): number;
  public region_get_connection_pathway_start(_region: RID, _connection: number): Vector2;
  public region_get_connection_pathway_end(_region: RID, _connection: number): Vector2;
  public region_get_random_point(_region: RID, _navigation_layers: number, _uniformly: boolean): Vector2;
  ...
  public link_set_start_position(_link: RID, _position: Vector2): void;
  public link_get_start_position(_link: RID): Vector2;
  public link_set_end_position(_link: RID, _position: Vector2): void;
  public link_get_end_position(_link: RID): Vector2;
  ...
  public agent_set_velocity_forced(_agent: RID, _velocity: Vector2): void;
  public agent_set_velocity(_agent: RID, _velocity: Vector2): void;
  public agent_get_velocity(_agent: RID): Vector2;
  public agent_set_position(_agent: RID, _position: Vector2): void;
  public agent_get_position(_agent: RID): Vector2;
  ...
  public obstacle_set_velocity(_obstacle: RID, _velocity: Vector2): void;
  public obstacle_get_velocity(_obstacle: RID): Vector2;
  public obstacle_set_position(_obstacle: RID, _position: Vector2): void;
  public obstacle_get_position(_obstacle: RID): Vector2;
  public obstacle_set_vertices(_obstacle: RID, _vertices: PackedVector2Array): void;
  ...
  public simplify_path(_path: PackedVector2Array, _epsilon: number): PackedVector2Array;

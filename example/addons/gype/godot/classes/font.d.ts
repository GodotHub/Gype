...
export declare class Font extends Resource{
  public set_fallbacks(_fallbacks: typedarray::Font): void;
  public get_fallbacks(): Array;
  ...
  public get fallbacks(): Array {
    get_fallbacks();
  }
  public set fallbacks(value: Array): void {
    set_fallbacks(value);
  }
}
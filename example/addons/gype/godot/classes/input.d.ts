...
declare global {
  export declare class _Input extends GodotObject {
    ...
    public is_action_pressed(
      _action: GDString | StringName | string,
      _exact_match: boolean = false
    ): boolean;
    public is_action_just_pressed(
      _action: GDString | StringName | string,
      _exact_match: boolean = false
    ): boolean;
    public is_action_just_released(
      _action: GDString | StringName | string,
      _exact_match: boolean = false
    ): boolean;
    public get_action_strength(
      _action: GDString | StringName | string,
      _exact_match: boolean = false
    ): number;
    public get_action_raw_strength(
      _action: GDString | StringName | string,
      _exact_match: boolean = false
    ): number;
    public get_axis(
      _negative_action: GDString | StringName | string,
      _positive_action: GDString | StringName | string
    ): number;
    public get_vector(
      _negative_x: GDString | StringName | string,
      _positive_x: GDString | StringName | string,
      _negative_y: GDString | StringName | string,
      _positive_y: GDString | StringName | string,
      _deadzone: number = -1.0
    ): Vector2;
    public add_joy_mapping(
      _mapping: GDString | StringName | string,
      _update_existing: boolean = false
    ): void;
    ...
    public start_joy_vibration(
      _device: number,
      _weak_magnitude: number,
      _strong_magnitude: number,
      _duration: number = 0
    ): void;
    public stop_joy_vibration(_device: number): void;
    public vibrate_handheld(
      _duration_ms: number = 500,
      _amplitude: number = -1.0
    ): void;
    ...
    public set_custom_mouse_cursor(
      _image: Resource,
      _shape: number = 0,
      _hotspot: Vector2 = Vector2(0, 0)
    ): void;

...
export declare class PhysicsRayQueryParameters3D extends RefCounted{
  public create(_from: Vector3, _to: Vector3, _collision_mask: number, _exclude: typedarray::RID): PhysicsRayQueryParameters3D;
  ...
  public set from(value: Vector3): void {
    set_from(value);
  }
  public get to(): Vector3 {
    get_to();
  }
  public set to(value: Vector3): void {
    set_to(value);
  }

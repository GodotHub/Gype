...
export declare class ClassDB extends Object{
  ...
  public instantiate(_class: StringName): Variant;
  ...
  public class_get_signal_list(_class: StringName, _no_inheritance: boolean): Array;
  public class_get_property_list(_class: StringName, _no_inheritance: boolean): Array;
  public class_get_property(_object: Object, _property: StringName): Variant;
  public class_set_property(_object: Object, _property: StringName, _value: Variant): number;
  public class_get_property_default_value(_class: StringName, _property: StringName): Variant;
  ...
  public class_get_method_list(_class: StringName, _no_inheritance: boolean): Array;

...
export declare class _ClassDB extends GodotObject{
  ...
  public class_get_signal_list(_class: GDString | StringName | string, _no_inheritance: boolean = false): GDArray;
  public class_get_property_list(_class: GDString | StringName | string, _no_inheritance: boolean = false): GDArray;
  ...
  public class_has_method(_class: GDString | StringName | string, _method: GDString | StringName | string, _no_inheritance: boolean = false): boolean;
  public class_get_method_argument_count(_class: GDString | StringName | string, _method: GDString | StringName | string, _no_inheritance: boolean = false): number;
  public class_get_method_list(_class: GDString | StringName | string, _no_inheritance: boolean = false): GDArray;
  public class_get_integer_constant_list(_class: GDString | StringName | string, _no_inheritance: boolean = false): PackedStringArray;
  ...
  public class_has_enum(_class: GDString | StringName | string, _name: GDString | StringName | string, _no_inheritance: boolean = false): boolean;
  public class_get_enum_list(_class: GDString | StringName | string, _no_inheritance: boolean = false): PackedStringArray;
  public class_get_enum_constants(_class: GDString | StringName | string, _enum: GDString | StringName | string, _no_inheritance: boolean = false): PackedStringArray;
  public class_get_integer_constant_enum(_class: GDString | StringName | string, _name: GDString | StringName | string, _no_inheritance: boolean = false): StringName;

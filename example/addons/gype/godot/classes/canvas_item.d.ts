...
export declare class CanvasItem extends Node{
  ...
  public draw_line(_from: Vector2, _to: Vector2, _color: Color, _width: number = -1.0, _antialiased: boolean = false): void;
  public draw_dashed_line(_from: Vector2, _to: Vector2, _color: Color, _width: number = -1.0, _dash: number = 2.0, _aligned: boolean = true, _antialiased: boolean = false): void;
  public draw_polyline(_points: PackedVector2Array, _color: Color, _width: number = -1.0, _antialiased: boolean = false): void;
  public draw_polyline_colors(_points: PackedVector2Array, _colors: PackedColorArray, _width: number = -1.0, _antialiased: boolean = false): void;
  public draw_arc(_center: Vector2, _radius: number, _start_angle: number, _end_angle: number, _point_count: number, _color: Color, _width: number = -1.0, _antialiased: boolean = false): void;
  public draw_multiline(_points: PackedVector2Array, _color: Color, _width: number = -1.0, _antialiased: boolean = false): void;
  public draw_multiline_colors(_points: PackedVector2Array, _colors: PackedColorArray, _width: number = -1.0, _antialiased: boolean = false): void;
  public draw_rect(_rect: Rect2, _color: Color, _filled: boolean = true, _width: number = -1.0, _antialiased: boolean = false): void;
  public draw_circle(_position: Vector2, _radius: number, _color: Color, _filled: boolean = true, _width: number = -1.0, _antialiased: boolean = false): void;
  public draw_texture(_texture: Texture2D, _position: Vector2, _modulate: Color = Color(1, 1, 1, 1)): void;
  public draw_texture_rect(_texture: Texture2D, _rect: Rect2, _tile: boolean, _modulate: Color = Color(1, 1, 1, 1), _transpose: boolean = false): void;
  public draw_texture_rect_region(_texture: Texture2D, _rect: Rect2, _src_rect: Rect2, _modulate: Color = Color(1, 1, 1, 1), _transpose: boolean = false, _clip_uv: boolean = true): void;
  public draw_msdf_texture_rect_region(_texture: Texture2D, _rect: Rect2, _src_rect: Rect2, _modulate: Color = Color(1, 1, 1, 1), _outline: number = 0.0, _pixel_range: number = 4.0, _scale: number = 1.0): void;
  public draw_lcd_texture_rect_region(_texture: Texture2D, _rect: Rect2, _src_rect: Rect2, _modulate: Color = Color(1, 1, 1, 1)): void;
  public draw_style_box(_style_box: StyleBox, _rect: Rect2): void;
  public draw_primitive(_points: PackedVector2Array, _colors: PackedColorArray, _uvs: PackedVector2Array, _texture: Texture2D = null): void;
  public draw_polygon(_points: PackedVector2Array, _colors: PackedColorArray, _uvs: PackedVector2Array = PackedVector2Array(), _texture: Texture2D = null): void;
  public draw_colored_polygon(_points: PackedVector2Array, _color: Color, _uvs: PackedVector2Array = PackedVector2Array(), _texture: Texture2D = null): void;
  public draw_string(_font: Font, _pos: Vector2, _text: GDString | StringName | string, _alignment: number = 0, _width: number = -1, _font_size: number = 16, _modulate: Color = Color(1, 1, 1, 1), _justification_flags: number = 3, _direction: number = 0, _orientation: number = 0): void;
  public draw_multiline_string(_font: Font, _pos: Vector2, _text: GDString | StringName | string, _alignment: number = 0, _width: number = -1, _font_size: number = 16, _max_lines: number = -1, _modulate: Color = Color(1, 1, 1, 1), _brk_flags: number = 3, _justification_flags: number = 3, _direction: number = 0, _orientation: number = 0): void;
  public draw_string_outline(_font: Font, _pos: Vector2, _text: GDString | StringName | string, _alignment: number = 0, _width: number = -1, _font_size: number = 16, _size: number = 1, _modulate: Color = Color(1, 1, 1, 1), _justification_flags: number = 3, _direction: number = 0, _orientation: number = 0): void;
  public draw_multiline_string_outline(_font: Font, _pos: Vector2, _text: GDString | StringName | string, _alignment: number = 0, _width: number = -1, _font_size: number = 16, _max_lines: number = -1, _size: number = 1, _modulate: Color = Color(1, 1, 1, 1), _brk_flags: number = 3, _justification_flags: number = 3, _direction: number = 0, _orientation: number = 0): void;
  public draw_char(_font: Font, _pos: Vector2, _char: GDString | StringName | string, _font_size: number = 16, _modulate: Color = Color(1, 1, 1, 1)): void;
  public draw_char_outline(_font: Font, _pos: Vector2, _char: GDString | StringName | string, _font_size: number = 16, _size: number = -1, _modulate: Color = Color(1, 1, 1, 1)): void;
  public draw_mesh(_mesh: Mesh, _texture: Texture2D, _transform: Transform2D = Transform2D(1, 0, 0, 1, 0, 0), _modulate: Color = Color(1, 1, 1, 1)): void;
  public draw_multimesh(_multimesh: MultiMesh, _texture: Texture2D): void;
  public draw_set_transform(_position: Vector2, _rotation: number = 0.0, _scale: Vector2 = Vector2(1, 1)): void;
  public draw_set_transform_matrix(_xform: Transform2D): void;
  public draw_animation_slice(_animation_length: number, _slice_begin: number, _slice_end: number, _offset: number = 0.0): void;

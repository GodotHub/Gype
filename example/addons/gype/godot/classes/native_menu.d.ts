...
export declare class NativeMenu extends Object{
  ...
  public add_submenu_item(_rid: RID, _label: String, _submenu_rid: RID, _tag: Variant, _index: number): number;
  public add_item(_rid: RID, _label: String, _callback: Callable, _key_callback: Callable, _tag: Variant, _accelerator: number, _index: number): number;
  public add_check_item(_rid: RID, _label: String, _callback: Callable, _key_callback: Callable, _tag: Variant, _accelerator: number, _index: number): number;
  public add_icon_item(_rid: RID, _icon: Texture2D, _label: String, _callback: Callable, _key_callback: Callable, _tag: Variant, _accelerator: number, _index: number): number;
  public add_icon_check_item(_rid: RID, _icon: Texture2D, _label: String, _callback: Callable, _key_callback: Callable, _tag: Variant, _accelerator: number, _index: number): number;
  public add_radio_check_item(_rid: RID, _label: String, _callback: Callable, _key_callback: Callable, _tag: Variant, _accelerator: number, _index: number): number;
  public add_icon_radio_check_item(_rid: RID, _icon: Texture2D, _label: String, _callback: Callable, _key_callback: Callable, _tag: Variant, _accelerator: number, _index: number): number;
  public add_multistate_item(_rid: RID, _label: String, _max_states: number, _default_state: number, _callback: Callable, _key_callback: Callable, _tag: Variant, _accelerator: number, _index: number): number;
  public add_separator(_rid: RID, _index: number): number;
  public find_item_index_with_text(_rid: RID, _text: String): number;
  public find_item_index_with_tag(_rid: RID, _tag: Variant): number;
  ...
  public get_item_tag(_rid: RID, _idx: number): Variant;
  ...
  public set_item_tag(_rid: RID, _idx: number, _tag: Variant): void;

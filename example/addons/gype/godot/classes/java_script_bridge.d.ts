...
export declare class JavaScriptBridge extends GodotObject{
  public eval(_code: GDString | StringName | string, _use_global_execution_context: boolean): any;
  ...
  public download_buffer(_buffer: PackedByteArray, _name: GDString | StringName | string, _mime: GDString | StringName | string): void;

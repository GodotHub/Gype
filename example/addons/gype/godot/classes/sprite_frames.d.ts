...
export declare class SpriteFrames extends Resource{
  ...
  public add_frame(_anim: GDString | StringName | string, _texture: Texture2D, _duration: number = 1.0, _at_position: number = -1): void;
  public set_frame(_anim: GDString | StringName | string, _idx: number, _texture: Texture2D, _duration: number = 1.0): void;

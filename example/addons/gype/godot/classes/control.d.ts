...
export declare class Control extends CanvasItem{
  ...
  public _structured_text_parser(_args: GDArray, _text: GDString | StringName | string): GDArray;
  ...
  public _make_custom_tooltip(_for_text: GDString | StringName | string): GodotObject;
  ...
  public set_anchors_preset(_preset: number, _keep_offsets: boolean = false): void;
  public set_offsets_preset(_preset: number, _resize_mode: number = 0, _margin: number = 0): void;
  public set_anchors_and_offsets_preset(_preset: number, _resize_mode: number = 0, _margin: number = 0): void;
  public set_anchor(_side: number, _anchor: number, _keep_offset: boolean = false, _push_opposite_anchor: boolean = true): void;
  ...
  public set_anchor_and_offset(_side: number, _anchor: number, _offset: number, _push_opposite_anchor: boolean = false): void;
  public set_begin(_position: Vector2): void;
  public set_end(_position: Vector2): void;
  public set_position(_position: Vector2, _keep_offsets: boolean = false): void;
  public set_size(_size: Vector2, _keep_offsets: boolean = false): void;
  public reset_size(): void;
  public set_custom_minimum_size(_size: Vector2): void;
  public set_global_position(_position: Vector2, _keep_offsets: boolean = false): void;
  ...
  public set_tooltip_text(_hint: GDString | StringName | string): void;
  public get_tooltip_text(): String;
  public get_tooltip(_at_position: Vector2 = Vector2(0, 0)): String;
  public set_default_cursor_shape(_shape: number): void;
  public get_default_cursor_shape(): number;
  public get_cursor_shape(_position: Vector2 = Vector2(0, 0)): number;
  public set_focus_neighbor(_side: number, _neighbor: GDString | NodePath | string): void;
  public get_focus_neighbor(_side: number): NodePath;
  public set_focus_next(_next: GDString | NodePath | string): void;
  public get_focus_next(): NodePath;
  public set_focus_previous(_previous: GDString | NodePath | string): void;

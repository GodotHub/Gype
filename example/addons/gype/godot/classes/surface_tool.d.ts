...
export declare class SurfaceTool extends RefCounted{
  ...
  public add_triangle_fan(_vertices: PackedVector3Array, _uvs: PackedVector2Array = PackedVector2Array(), _colors: PackedColorArray = PackedColorArray(), _uv2s: PackedVector2Array = PackedVector2Array(), _normals: PackedVector3Array = PackedVector3Array(), _tangents: GDArray = Array[Plane]([])): void;
  public add_index(_index: number): void;
  public index(): void;
  public deindex(): void;
  public generate_normals(_flip: boolean = false): void;
  public generate_tangents(): void;
  public optimize_indices_for_cache(): void;
  public get_aabb(): AABB;
  public generate_lod(_nd_threshold: number, _target_index_count: number = 3): PackedInt32Array;
  ...
  public create_from_arrays(_arrays: GDArray, _primitive_type: number = 3): void;
  ...
  public commit(_existing: ArrayMesh = null, _flags: number = 0): ArrayMesh;

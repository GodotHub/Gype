...
export declare class WorkerThreadPool extends GodotObject{
  public add_task(_action: Callable, _high_priority: boolean, _description: String | StringName | string): number;
  public is_task_completed(_task_id: number): boolean;
  public wait_for_task_completion(_task_id: number): number;
  public add_group_task(_action: Callable, _elements: number, _tasks_needed: number, _high_priority: boolean, _description: String | StringName | string): number;

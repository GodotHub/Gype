...
export declare class Curve3D extends Resource{
  ...
  public add_point(_position: Vector3, _in: Vector3 = Vector3(0, 0, 0), _out: Vector3 = Vector3(0, 0, 0), _index: number = -1): void;
  ...
  public sample_baked(_offset: number = 0.0, _cubic: boolean = false): Vector3;
  public sample_baked_with_rotation(_offset: number = 0.0, _cubic: boolean = false, _apply_tilt: boolean = false): Transform3D;
  public sample_baked_up_vector(_offset: number, _apply_tilt: boolean = false): Vector3;
  ...
  public tessellate(_max_stages: number = 5, _tolerance_degrees: number = 4): PackedVector3Array;
  public tessellate_even_length(_max_stages: number = 5, _tolerance_length: number = 0.2): PackedVector3Array;

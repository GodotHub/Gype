...
export declare class GPUParticles3D extends GeometryInstance3D{
  ...
  public set amount_ratio(value: number): void {
    set_amount_ratio(value);
  }
  public get sub_emitter(): NodePath {
    get_sub_emitter();
  }
  public set sub_emitter(value: NodePath): void {
  ...
  public set interp_to_end(value: number): void {
  ...
  public set interpolate(value: boolean): void {
  ...
  public set collision_base_size(value: number): void {
  ...
  public set transform_align(value: number): void {
    set_transform_align(value);
  }
  public get trail_enabled(): boolean {
    is_trail_enabled();
  }
  public set trail_enabled(value: boolean): void {
    set_trail_enabled(value);
  }
  public get trail_lifetime(): number {
    get_trail_lifetime();
  }
  public set trail_lifetime(value: number): void {
    set_trail_lifetime(value);
  }
  public get process_material(): ParticleProcessMaterial,ShaderMaterial {
    get_process_material();
  }
  public set process_material(value: ParticleProcessMaterial,ShaderMaterial): void {
    set_process_material(value);
  }
  public get draw_passes(): number {
    get_draw_passes();
  }
  public set draw_passes(value: number): void {
    set_draw_passes(value);
  }
  public get draw_pass_1(): Mesh {
    get_draw_pass_mesh();
  }
  public set draw_pass_1(value: Mesh): void {
    set_draw_pass_mesh(value);
  }
  public get draw_pass_2(): Mesh {
    get_draw_pass_mesh();
  }
  public set draw_pass_2(value: Mesh): void {
    set_draw_pass_mesh(value);
  }
  public get draw_pass_3(): Mesh {
    get_draw_pass_mesh();
  }
  public set draw_pass_3(value: Mesh): void {
    set_draw_pass_mesh(value);
  }
  public get draw_pass_4(): Mesh {
    get_draw_pass_mesh();
  }
  public set draw_pass_4(value: Mesh): void {
    set_draw_pass_mesh(value);
  }
  public get draw_skin(): Skin {
    get_skin();
  }
  public set draw_skin(value: Skin): void {
    set_skin(value);
  }
  static DrawOrder = {
    DRAW_ORDER_INDEX = 0,

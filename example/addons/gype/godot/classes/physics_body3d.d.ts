...
export declare class PhysicsBody3D extends CollisionObject3D{
  ...
  public set axis_lock_linear_x(value: boolean): void {
    set_axis_lock(value);
  }
  public get axis_lock_linear_y(): boolean {
    get_axis_lock();
  }
  public set axis_lock_linear_y(value: boolean): void {
    set_axis_lock(value);
  }
  public get axis_lock_linear_z(): boolean {
    get_axis_lock();
  }
  public set axis_lock_linear_z(value: boolean): void {
    set_axis_lock(value);
  }
  public get axis_lock_angular_x(): boolean {
    get_axis_lock();
  }
  public set axis_lock_angular_x(value: boolean): void {
    set_axis_lock(value);
  }
  public get axis_lock_angular_y(): boolean {
    get_axis_lock();
  }
  public set axis_lock_angular_y(value: boolean): void {
    set_axis_lock(value);
  }
  public get axis_lock_angular_z(): boolean {
    get_axis_lock();
  }
  public set axis_lock_angular_z(value: boolean): void {
    set_axis_lock(value);
  }
}
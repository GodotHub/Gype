...
export declare class EditorPlugin extends Node{
  ...
  public _edit(_object: GodotObject): void;
  public _handles(_object: GodotObject): boolean;
  public _get_state(): Dictionary;
  public _set_state(_state: Dictionary): void;
  public _clear(): void;
  public _get_unsaved_status(_for_scene: GDString | StringName | string): String;
  ...
  public add_tool_menu_item(_name: GDString | StringName | string, _callable: Callable): void;
  public add_tool_submenu_item(_name: GDString | StringName | string, _submenu: PopupMenu): void;
  public remove_tool_menu_item(_name: GDString | StringName | string): void;
  public get_export_as_menu(): PopupMenu;
  public add_custom_type(_type: GDString | StringName | string, _base: GDString | StringName | string, _script: Script, _icon: Texture2D): void;
  public remove_custom_type(_type: GDString | StringName | string): void;
  public add_autoload_singleton(_name: GDString | StringName | string, _path: GDString | StringName | string): void;
  public remove_autoload_singleton(_name: GDString | StringName | string): void;

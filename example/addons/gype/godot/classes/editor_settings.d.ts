...
export declare class EditorSettings extends Resource{
  ...
  public get_setting(_name: GDString | StringName | string): any;
  public erase(_property: GDString | StringName | string): void;
  ...
  public set_builtin_action_override(_name: GDString | StringName | string, _actions_list: GDArray): void;
  public check_changed_settings_in_group(_setting_prefix: GDString | StringName | string): boolean;
  public get_changed_settings(): PackedStringArray;
  public mark_setting_changed(_setting: GDString | StringName | string): void;

...
export declare class EditorResourcePreview extends Node{
  public queue_resource_preview(_path: String, _receiver: Object, _receiver_func: StringName, _userdata: Variant): void;
  public queue_edited_resource_preview(_resource: Resource, _receiver: Object, _receiver_func: StringName, _userdata: Variant): void;

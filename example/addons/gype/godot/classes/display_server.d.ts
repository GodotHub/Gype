...
export declare class DisplayServer extends Object{
  ...
  public global_menu_is_item_disabled(_menu_root: String, _idx: number): boolean;
  public global_menu_is_item_hidden(_menu_root: String, _idx: number): boolean;
  public global_menu_get_item_tooltip(_menu_root: String, _idx: number): String;
  public global_menu_get_item_state(_menu_root: String, _idx: number): number;
  public global_menu_get_item_max_states(_menu_root: String, _idx: number): number;
  public global_menu_get_item_icon(_menu_root: String, _idx: number): Texture2D;
  public global_menu_get_item_indentation_level(_menu_root: String, _idx: number): number;
  public global_menu_set_item_checked(_menu_root: String, _idx: number, _checked: boolean): void;
  public global_menu_set_item_checkable(_menu_root: String, _idx: number, _checkable: boolean): void;
  public global_menu_set_item_radio_checkable(_menu_root: String, _idx: number, _checkable: boolean): void;
  ...
  public global_menu_set_item_disabled(_menu_root: String, _idx: number, _disabled: boolean): void;
  public global_menu_set_item_hidden(_menu_root: String, _idx: number, _hidden: boolean): void;
  public global_menu_set_item_tooltip(_menu_root: String, _idx: number, _tooltip: String): void;
  public global_menu_set_item_state(_menu_root: String, _idx: number, _state: number): void;
  public global_menu_set_item_max_states(_menu_root: String, _idx: number, _max_states: number): void;
  public global_menu_set_item_icon(_menu_root: String, _idx: number, _icon: Texture2D): void;
  public global_menu_set_item_indentation_level(_menu_root: String, _idx: number, _level: number): void;
  public global_menu_get_item_count(_menu_root: String): number;
  public global_menu_remove_item(_menu_root: String, _idx: number): void;
  public global_menu_clear(_menu_root: String): void;
  ...
  public clipboard_set(_clipboard: String): void;
  ...
  public window_set_title(_title: String, _window_id: number): void;
  public window_get_title_size(_title: String, _window_id: number): Vector2i;
  ...
  public virtual_keyboard_show(_existing_text: String, _position: Rect2, _type: number, _max_length: number, _cursor_start: number, _cursor_end: number): void;
  ...
  public set_native_icon(_filename: String): void;
  public set_icon(_image: Image): void;
  public create_status_indicator(_icon: Texture2D, _tooltip: String, _callback: Callable): number;
  public status_indicator_set_icon(_id: number, _icon: Texture2D): void;
  public status_indicator_set_tooltip(_id: number, _tooltip: String): void;
  ...
  public tablet_set_current_driver(_name: String): void;

...
export declare class CodeHighlighter extends SyntaxHighlighter{
  public add_keyword_color(_keyword: String | StringName | string, _color: Color): void;
  public remove_keyword_color(_keyword: String | StringName | string): void;
  public has_keyword_color(_keyword: String | StringName | string): boolean;
  public get_keyword_color(_keyword: String | StringName | string): Color;
  public set_keyword_colors(_keywords: Dictionary): void;
  public clear_keyword_colors(): void;
  public get_keyword_colors(): Dictionary;
  public add_member_keyword_color(_member_keyword: String | StringName | string, _color: Color): void;
  public remove_member_keyword_color(_member_keyword: String | StringName | string): void;
  public has_member_keyword_color(_member_keyword: String | StringName | string): boolean;
  public get_member_keyword_color(_member_keyword: String | StringName | string): Color;
  ...
  public add_color_region(_start_key: String | StringName | string, _end_key: String | StringName | string, _color: Color, _line_only: boolean): void;
  public remove_color_region(_start_key: String | StringName | string): void;
  public has_color_region(_start_key: String | StringName | string): boolean;

...
export declare class EditorImportPlugin extends ResourceImporter{
  ...
  public _get_import_options(_path: String, _preset_index: number): GDArray;
  ...
  public _import(_source_file: String, _save_path: String, _options: Dictionary, _platform_variants: GDArray, _gen_files: GDArray): number;
  public _can_import_threaded(): boolean;
  public append_import_external_resource(_path: String, _custom_options: Dictionary, _custom_importer: String, _generator_parameters: any): number;
}
...
export declare class Crypto extends RefCounted{
  ...
  public generate_self_signed_certificate(_key: CryptoKey, _issuer_name: GDString | StringName | string, _not_before: GDString | StringName | string, _not_after: GDString | StringName | string): X509Certificate;

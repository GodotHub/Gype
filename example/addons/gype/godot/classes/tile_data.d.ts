...
export declare class TileData extends Object{
  ...
  public set_custom_data(_layer_name: String, _value: Variant): void;
  public get_custom_data(_layer_name: String): Variant;
  public set_custom_data_by_layer_id(_layer_id: number, _value: Variant): void;
  public get_custom_data_by_layer_id(_layer_id: number): Variant;
  ...
  public set transpose(value: boolean): void {
    set_transpose(value);
  }
  public get texture_origin(): Vector2i {
    get_texture_origin();
  }
  public set texture_origin(value: Vector2i): void {
  ...
  public set terrain_set(value: number): void {
    set_terrain_set(value);
  }
  public get terrain(): number {
    get_terrain();
  }
  public set terrain(value: number): void {
    set_terrain(value);
  }
  public get probability(): number {
    get_probability();
  }
  public set probability(value: number): void {

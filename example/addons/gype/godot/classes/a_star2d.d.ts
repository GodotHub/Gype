...
export declare class AStar2D extends RefCounted{
  ...
  public add_point(_id: number, _position: Vector2, _weight_scale: number): void;
  ...
  public clear(): void;
  public get_closest_point(_to_position: Vector2, _include_disabled: boolean): number;
  public get_closest_position_in_segment(_to_position: Vector2): Vector2;
  public get_point_path(_from_id: number, _to_id: number, _allow_partial_path: boolean): PackedVector2Array;

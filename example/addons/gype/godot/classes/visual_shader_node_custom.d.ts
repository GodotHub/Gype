...
export declare class VisualShaderNodeCustom extends VisualShaderNode{
  ...
  public _get_input_port_default_value(_port: number): Variant;
  ...
  public _get_code(_input_vars: typedarray::String, _output_vars: typedarray::String, _mode: number, _type: number): String;
  ...
  public set properties(value: String): void {

...
export declare class XRNode3D extends Node3D{
  ...
  public set_pose_name(_pose: String | StringName | string): void;
  ...
  public trigger_haptic_pulse(_action_name: String | StringName | string, _frequency: number, _amplitude: number, _duration_sec: number, _delay_sec: number): void;

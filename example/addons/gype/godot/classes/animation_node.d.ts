...
export declare class AnimationNode extends Resource{
  ...
  public blend_animation(_animation: GDString | StringName | string, _time: number, _delta: number, _seeked: boolean, _is_external_seeking: boolean, _blend: number, _looped_flag: number = 0): void;
  public blend_node(_name: GDString | StringName | string, _node: AnimationNode, _time: number, _seek: boolean, _is_external_seeking: boolean, _blend: number, _filter: number = 0, _sync: boolean = true, _test_only: boolean = false): number;
  public blend_input(_input_index: number, _time: number, _seek: boolean, _is_external_seeking: boolean, _blend: number, _filter: number = 0, _sync: boolean = true, _test_only: boolean = false): number;

...
export declare class OS extends GodotObject{
  ...
  public alert(_text: String | StringName | string, _title: String | StringName | string): void;
  public crash(_message: String | StringName | string): void;
  ...
  public get_system_font_path(_font_name: String | StringName | string, _weight: number, _stretch: number, _italic: boolean): String;
  public get_system_font_path_for_text(_font_name: String | StringName | string, _text: String | StringName | string, _locale: String | StringName | string, _script: String | StringName | string, _weight: number, _stretch: number, _italic: boolean): PackedStringArray;
  public get_executable_path(): String;
  public read_string_from_stdin(): String;
  public execute(_path: String | StringName | string, _arguments: PackedStringArray, _output: GDArray, _read_stderr: boolean, _open_console: boolean): number;
  public execute_with_pipe(_path: String | StringName | string, _arguments: PackedStringArray): Dictionary;
  public create_process(_path: String | StringName | string, _arguments: PackedStringArray, _open_console: boolean): number;
  public create_instance(_arguments: PackedStringArray): number;
  public kill(_pid: number): number;
  public shell_open(_uri: String | StringName | string): number;
  public shell_show_in_file_manager(_file_or_dir_path: String | StringName | string, _open_folder: boolean): number;
  public is_process_running(_pid: number): boolean;
  public get_process_exit_code(_pid: number): number;
  public get_process_id(): number;
  public has_environment(_variable: String | StringName | string): boolean;
  public get_environment(_variable: String | StringName | string): String;
  public set_environment(_variable: String | StringName | string, _value: String | StringName | string): void;
  public unset_environment(_variable: String | StringName | string): void;
  ...
  public move_to_trash(_path: String | StringName | string): number;
  ...
  public find_keycode_from_string(_string: String | StringName | string): number;
  public set_use_file_access_save_and_swap(_enabled: boolean): void;
  public set_thread_name(_name: String | StringName | string): number;
  public get_thread_caller_id(): number;
  public get_main_thread_id(): number;
  public has_feature(_tag_name: String | StringName | string): boolean;
  public is_sandboxed(): boolean;
  public request_permission(_name: String | StringName | string): boolean;

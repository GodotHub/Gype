...
export declare class SceneTree extends MainLoop{
  ...
  public get_processed_tweens(): Array;
  ...
  public set_group_flags(_call_flags: number, _group: StringName, _property: String, _value: Variant): void;
  ...
  public set_group(_group: StringName, _property: String, _value: Variant): void;
  public get_nodes_in_group(_group: StringName): Array;
  ...
  public set edited_scene_root(value: Node): void {
    set_edited_scene_root(value);
  }
  public get current_scene(): Node {
    get_current_scene();
  }
  public set current_scene(value: Node): void {

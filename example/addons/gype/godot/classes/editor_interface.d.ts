...
export declare class EditorInterface extends Object{
  ...
  public set_main_screen_editor(_name: String): void;
  ...
  public inspect_object(_object: Object, _for_property: String, _inspector_only: boolean): void;
  ...
  public open_scene_from_path(_scene_filepath: String): void;
  public reload_scene_from_path(_scene_filepath: String): void;
  public get_open_scenes(): PackedStringArray;
  public get_edited_scene_root(): Node;
  public save_scene(): number;
  public save_scene_as(_path: String, _with_preview: boolean): void;
  public save_all_scenes(): void;
  public mark_scene_as_unsaved(): void;
  public play_main_scene(): void;
  public play_current_scene(): void;
  public play_custom_scene(_scene_filepath: String): void;

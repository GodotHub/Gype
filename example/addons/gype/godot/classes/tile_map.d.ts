...
export declare class TileMap extends Node2D{
  ...
  public force_update(_layer: number = -1): void;
  ...
  public set_cell(_layer: number, _coords: Vector2i, _source_id: number = -1, _atlas_coords: Vector2i = Vector2i(-1, -1), _alternative_tile: number = 0): void;
  public erase_cell(_layer: number, _coords: Vector2i): void;
  public get_cell_source_id(_layer: number, _coords: Vector2i, _use_proxies: boolean = false): number;
  public get_cell_atlas_coords(_layer: number, _coords: Vector2i, _use_proxies: boolean = false): Vector2i;
  public get_cell_alternative_tile(_layer: number, _coords: Vector2i, _use_proxies: boolean = false): number;
  public get_cell_tile_data(_layer: number, _coords: Vector2i, _use_proxies: boolean = false): TileData;
  ...
  public set_cells_terrain_connect(_layer: number, _cells: GDArray, _terrain_set: number, _terrain: number, _ignore_empty_terrains: boolean = true): void;
  public set_cells_terrain_path(_layer: number, _path: GDArray, _terrain_set: number, _terrain: number, _ignore_empty_terrains: boolean = true): void;
  public fix_invalid_tiles(): void;
  public clear_layer(_layer: number): void;
  public clear(): void;
  public update_internals(): void;
  public notify_runtime_tile_data_update(_layer: number = -1): void;
  public get_surrounding_cells(_coords: Vector2i): GDArray;
  public get_used_cells(_layer: number): GDArray;
  public get_used_cells_by_id(_layer: number, _source_id: number = -1, _atlas_coords: Vector2i = Vector2i(-1, -1), _alternative_tile: number = -1): GDArray;

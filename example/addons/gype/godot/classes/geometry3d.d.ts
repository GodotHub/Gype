...
export declare class Geometry3D extends Object{
  public compute_convex_mesh_points(_planes: typedarray::Plane): PackedVector3Array;
  public build_box_planes(_extents: Vector3): Array;
  public build_cylinder_planes(_radius: number, _height: number, _sides: number, _axis: number): Array;
  public build_capsule_planes(_radius: number, _height: number, _sides: number, _lats: number, _axis: number): Array;
  ...
  public ray_intersects_triangle(_from: Vector3, _dir: Vector3, _a: Vector3, _b: Vector3, _c: Vector3): Variant;
  public segment_intersects_triangle(_from: Vector3, _to: Vector3, _a: Vector3, _b: Vector3, _c: Vector3): Variant;
  ...
  public segment_intersects_convex(_from: Vector3, _to: Vector3, _planes: typedarray::Plane): PackedVector3Array;

...
export declare class RigidBody3D extends PhysicsBody3D{
  ...
  public set inertia(value: Vector3): void {
    set_inertia(value);
  }
  ...
  public set continuous_cd(value: boolean): void {
  ...
  public set constant_force(value: Vector3): void {
    set_constant_force(value);
  }
  public get constant_torque(): Vector3 {
    get_constant_torque();
  }
  public set constant_torque(value: Vector3): void {

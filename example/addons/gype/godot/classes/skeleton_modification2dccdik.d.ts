...
export declare class SkeletonModification2DCCDIK extends SkeletonModification2D{
  ...
  public set_tip_node(_tip_nodepath: GDString | NodePath | string): void;
  ...
  public set_ccdik_joint_bone2d_node(_joint_idx: number, _bone2d_nodepath: GDString | NodePath | string): void;

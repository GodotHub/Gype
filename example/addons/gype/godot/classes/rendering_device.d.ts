...
export declare class RenderingDevice extends GodotObject{
  ...
  public texture_create_shared_from_slice(_view: RDTextureView, _with_texture: RID, _layer: number, _mipmap: number, _mipmaps: number = 1, _slice_type: number = 0): RID;
  ...
  public framebuffer_format_create(_attachments: GDArray, _view_count: number = 1): number;
  public framebuffer_format_create_multipass(_attachments: GDArray, _passes: GDArray, _view_count: number = 1): number;
  public framebuffer_format_create_empty(_samples: number = 0): number;
  public framebuffer_format_get_texture_samples(_format: number, _render_pass: number = 0): number;
  public framebuffer_create(_textures: GDArray, _validate_with_format: number = -1, _view_count: number = 1): RID;
  public framebuffer_create_multipass(_textures: GDArray, _passes: GDArray, _validate_with_format: number = -1, _view_count: number = 1): RID;
  public framebuffer_create_empty(_size: Vector2i, _samples: number = 0, _validate_with_format: number = -1): RID;
  ...
  public vertex_buffer_create(_size_bytes: number, _data: PackedByteArray = PackedByteArray(), _use_as_storage: boolean = false): RID;
  public vertex_format_create(_vertex_descriptions: GDArray): number;
  public vertex_array_create(_vertex_count: number, _vertex_format: number, _src_buffers: GDArray, _offsets: PackedInt64Array = PackedInt64Array()): RID;
  public index_buffer_create(_size_indices: number, _format: number, _data: PackedByteArray = PackedByteArray(), _use_restart_indices: boolean = false): RID;
  public index_array_create(_index_buffer: RID, _index_offset: number, _index_count: number): RID;
  public shader_compile_spirv_from_source(_shader_source: RDShaderSource, _allow_cache: boolean = true): RDShaderSPIRV;
  ...
  public shader_create_from_bytecode(_binary_data: PackedByteArray, _placeholder_rid: RID = RID()): RID;
  public shader_create_placeholder(): RID;
  public shader_get_vertex_input_attribute_mask(_shader: RID): number;
  public uniform_buffer_create(_size_bytes: number, _data: PackedByteArray = PackedByteArray()): RID;
  public storage_buffer_create(_size_bytes: number, _data: PackedByteArray = PackedByteArray(), _usage: number = 0): RID;
  public texture_buffer_create(_size_bytes: number, _format: number, _data: PackedByteArray = PackedByteArray()): RID;
  public uniform_set_create(_uniforms: GDArray, _shader: RID, _shader_set: number): RID;
  ...
  public buffer_get_data(_buffer: RID, _offset_bytes: number = 0, _size_bytes: number = 0): PackedByteArray;
  public render_pipeline_create(_shader: RID, _framebuffer_format: number, _vertex_format: number, _primitive: number, _rasterization_state: RDPipelineRasterizationState, _multisample_state: RDPipelineMultisampleState, _stencil_state: RDPipelineDepthStencilState, _color_blend_state: RDPipelineColorBlendState, _dynamic_state_flags: number = 0, _for_render_pass: number = 0, _specialization_constants: GDArray = Array[RDPipelineSpecializationConstant]([])): RID;
  public render_pipeline_is_valid(_render_pipeline: RID): boolean;
  public compute_pipeline_create(_shader: RID, _specialization_constants: GDArray = Array[RDPipelineSpecializationConstant]([])): RID;
  public compute_pipeline_is_valid(_compute_pipeline: RID): boolean;
  public screen_get_width(_screen: number = 0): number;
  public screen_get_height(_screen: number = 0): number;
  public screen_get_framebuffer_format(_screen: number = 0): number;
  public draw_list_begin_for_screen(_screen: number = 0, _clear_color: Color = Color(0, 0, 0, 1)): number;
  public draw_list_begin(_framebuffer: RID, _initial_color_action: number, _final_color_action: number, _initial_depth_action: number, _final_depth_action: number, _clear_color_values: PackedColorArray = PackedColorArray(), _clear_depth: number = 1.0, _clear_stencil: number = 0, _region: Rect2 = Rect2(0, 0, 0, 0)): number;
  public draw_list_begin_split(_framebuffer: RID, _splits: number, _initial_color_action: number, _final_color_action: number, _initial_depth_action: number, _final_depth_action: number, _clear_color_values: PackedColorArray = PackedColorArray(), _clear_depth: number = 1.0, _clear_stencil: number = 0, _region: Rect2 = Rect2(0, 0, 0, 0), _storage_textures: GDArray = Array[RID]([])): PackedInt64Array;
  ...
  public draw_list_draw(_draw_list: number, _use_indices: boolean, _instances: number, _procedural_vertex_count: number = 0): void;
  public draw_list_enable_scissor(_draw_list: number, _rect: Rect2 = Rect2(0, 0, 0, 0)): void;
  ...
  public submit(): void;
  public sync(): void;
  public barrier(_from: number = 32767, _to: number = 32767): void;

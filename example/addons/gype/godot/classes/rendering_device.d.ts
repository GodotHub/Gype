...
export declare class RenderingDevice extends GodotObject{
  ...
  public framebuffer_format_create(_attachments: GDArray, _view_count: number): number;
  public framebuffer_format_create_multipass(_attachments: GDArray, _passes: GDArray, _view_count: number): number;
  ...
  public framebuffer_create(_textures: GDArray, _validate_with_format: number, _view_count: number): RID;
  public framebuffer_create_multipass(_textures: GDArray, _passes: GDArray, _validate_with_format: number, _view_count: number): RID;
  ...
  public vertex_array_create(_vertex_count: number, _vertex_format: number, _src_buffers: GDArray, _offsets: PackedInt64Array): RID;
  ...
  public render_pipeline_create(_shader: RID, _framebuffer_format: number, _vertex_format: number, _primitive: number, _rasterization_state: RDPipelineRasterizationState, _multisample_state: RDPipelineMultisampleState, _stencil_state: RDPipelineDepthStencilState, _color_blend_state: RDPipelineColorBlendState, _dynamic_state_flags: number, _for_render_pass: number, _specialization_constants: GDArray): RID;
  public render_pipeline_is_valid(_render_pipeline: RID): boolean;
  public compute_pipeline_create(_shader: RID, _specialization_constants: GDArray): RID;
  ...
  public draw_list_begin_split(_framebuffer: RID, _splits: number, _initial_color_action: number, _final_color_action: number, _initial_depth_action: number, _final_depth_action: number, _clear_color_values: PackedColorArray, _clear_depth: number, _clear_stencil: number, _region: Rect2, _storage_textures: GDArray): PackedInt64Array;

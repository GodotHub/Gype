...
export declare class GraphNode extends GraphElement{
  ...
  public set_slot(_slot_index: number, _enable_left_port: boolean, _type_left: number, _color_left: Color, _enable_right_port: boolean, _type_right: number, _color_right: Color, _custom_icon_left: Texture2D = null, _custom_icon_right: Texture2D = null, _draw_stylebox: boolean = true): void;

...
export declare class PacketPeerUDP extends PacketPeer{
  public bind(_port: number, _bind_address: String, _recv_buf_size: number): number;
  public close(): void;
  public wait(): number;
  ...
  public set_dest_address(_host: String, _port: number): number;
  public set_broadcast_enabled(_enabled: boolean): void;
  public join_multicast_group(_multicast_address: String, _interface_name: String): number;
  public leave_multicast_group(_multicast_address: String, _interface_name: String): number;
}
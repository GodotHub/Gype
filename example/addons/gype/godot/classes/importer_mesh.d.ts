...
export declare class ImporterMesh extends Resource{
  ...
  public add_surface(_primitive: number, _arrays: GDArray, _blend_shapes: GDArray = Array[Array]([]), _lods: Dictionary = {}, _material: Material = null, _name: GDString | StringName | string = "", _flags: number = 0): void;
  ...
  public get_mesh(_base_mesh: ArrayMesh = null): ArrayMesh;
  public clear(): void;

...
export declare class Script extends Resource{
  ...
  public set_source_code(_source: String | StringName | string): void;
  ...
  public has_script_signal(_signal_name: String | StringName | string): boolean;
  ...
  public get_property_default_value(_property: String | StringName | string): any;

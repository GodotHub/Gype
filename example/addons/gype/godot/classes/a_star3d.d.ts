...
export declare class AStar3D extends RefCounted{
  ...
  public add_point(_id: number, _position: Vector3, _weight_scale: number = 1.0): void;
  ...
  public clear(): void;
  public get_closest_point(_to_position: Vector3, _include_disabled: boolean = false): number;
  public get_closest_position_in_segment(_to_position: Vector3): Vector3;
  public get_point_path(_from_id: number, _to_id: number, _allow_partial_path: boolean = false): PackedVector3Array;

...
export declare class VisualShaderNodeGroupBase extends VisualShaderNodeResizableBase{
  ...
  public set_outputs(_outputs: GDString | StringName | string): void;
  public get_outputs(): String;
  public is_valid_port_name(_name: GDString | StringName | string): boolean;
  public add_input_port(_id: number, _type: number, _name: GDString | StringName | string): void;
  ...
  public add_output_port(_id: number, _type: number, _name: GDString | StringName | string): void;
  ...
  public set_input_port_name(_id: number, _name: GDString | StringName | string): void;
  public set_input_port_type(_id: number, _type: number): void;
  public set_output_port_name(_id: number, _name: GDString | StringName | string): void;

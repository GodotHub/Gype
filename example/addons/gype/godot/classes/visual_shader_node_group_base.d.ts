...
export declare class VisualShaderNodeGroupBase extends VisualShaderNodeResizableBase{
  public set_inputs(_inputs: String): void;
  public get_inputs(): String;
  public set_outputs(_outputs: String): void;
  public get_outputs(): String;
  public is_valid_port_name(_name: String): boolean;
  public add_input_port(_id: number, _type: number, _name: String): void;
  ...
  public add_output_port(_id: number, _type: number, _name: String): void;
  ...
  public set_input_port_name(_id: number, _name: String): void;
  public set_input_port_type(_id: number, _type: number): void;
  public set_output_port_name(_id: number, _name: String): void;

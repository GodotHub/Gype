...
export declare class EditorFileSystem extends Node{
  ...
  public update_file(_path: GDString | StringName | string): void;
  public get_filesystem_path(_path: GDString | StringName | string): EditorFileSystemDirectory;
  public get_file_type(_path: GDString | StringName | string): String;

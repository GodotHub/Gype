...
export declare class Time extends GodotObject{
  ...
  public get_datetime_dict_from_datetime_string(_datetime: String | StringName | string, _weekday: boolean): Dictionary;
  ...
  public get_unix_time_from_datetime_string(_datetime: String | StringName | string): number;

...
export declare class TextServer extends RefCounted{
  ...
  public load_support_data(_filename: String | StringName | string): boolean;
  public get_support_data_filename(): String;
  public get_support_data_info(): String;
  public save_support_data(_filename: String | StringName | string): boolean;
  public is_locale_right_to_left(_locale: String | StringName | string): boolean;
  public name_to_tag(_name: String | StringName | string): number;
  ...
  public font_set_name(_font_rid: RID, _name: String | StringName | string): void;
  public font_get_name(_font_rid: RID): String;
  public font_get_ot_name_strings(_font_rid: RID): Dictionary;
  public font_set_style_name(_font_rid: RID, _name: String | StringName | string): void;
  ...
  public font_is_language_supported(_font_rid: RID, _language: String | StringName | string): boolean;
  public font_set_language_support_override(_font_rid: RID, _language: String | StringName | string, _supported: boolean): void;
  public font_get_language_support_override(_font_rid: RID, _language: String | StringName | string): boolean;
  public font_remove_language_support_override(_font_rid: RID, _language: String | StringName | string): void;
  public font_get_language_support_overrides(_font_rid: RID): PackedStringArray;
  public font_is_script_supported(_font_rid: RID, _script: String | StringName | string): boolean;
  public font_set_script_support_override(_font_rid: RID, _script: String | StringName | string, _supported: boolean): void;
  public font_get_script_support_override(_font_rid: RID, _script: String | StringName | string): boolean;
  public font_remove_script_support_override(_font_rid: RID, _script: String | StringName | string): void;
  ...
  public shaped_text_set_custom_punctuation(_shaped: RID, _punct: String | StringName | string): void;
  ...
  public shaped_text_add_string(_shaped: RID, _text: String | StringName | string, _fonts: GDArray, _size: number, _opentype_features: Dictionary, _language: String | StringName | string, _meta: any): boolean;
  ...
  public format_number(_number: String | StringName | string, _language: String | StringName | string): String;
  public parse_number(_number: String | StringName | string, _language: String | StringName | string): String;
  public percent_sign(_language: String | StringName | string): String;
  public string_get_word_breaks(_string: String | StringName | string, _language: String | StringName | string, _chars_per_line: number): PackedInt32Array;
  public string_get_character_breaks(_string: String | StringName | string, _language: String | StringName | string): PackedInt32Array;
  public is_confusable(_string: String | StringName | string, _dict: PackedStringArray): number;
  public spoof_check(_string: String | StringName | string): boolean;
  public strip_diacritics(_string: String | StringName | string): String;
  public is_valid_identifier(_string: String | StringName | string): boolean;
  public is_valid_letter(_unicode: number): boolean;
  public string_to_upper(_string: String | StringName | string, _language: String | StringName | string): String;
  public string_to_lower(_string: String | StringName | string, _language: String | StringName | string): String;
  public string_to_title(_string: String | StringName | string, _language: String | StringName | string): String;
  public parse_structured_text(_parser_type: number, _args: GDArray, _text: String | StringName | string): GDArray;

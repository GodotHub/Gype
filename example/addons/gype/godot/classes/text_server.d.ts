...
export declare class TextServer extends RefCounted{
  ...
  public load_support_data(_filename: GDString | StringName | string): boolean;
  public get_support_data_filename(): String;
  public get_support_data_info(): String;
  public save_support_data(_filename: GDString | StringName | string): boolean;
  public is_locale_right_to_left(_locale: GDString | StringName | string): boolean;
  public name_to_tag(_name: GDString | StringName | string): number;
  ...
  public font_set_name(_font_rid: RID, _name: GDString | StringName | string): void;
  public font_get_name(_font_rid: RID): String;
  public font_get_ot_name_strings(_font_rid: RID): Dictionary;
  public font_set_style_name(_font_rid: RID, _name: GDString | StringName | string): void;
  ...
  public font_remove_language_support_override(_font_rid: RID, _language: GDString | StringName | string): void;
  public font_get_language_support_overrides(_font_rid: RID): PackedStringArray;
  public font_is_script_supported(_font_rid: RID, _script: GDString | StringName | string): boolean;
  public font_set_script_support_override(_font_rid: RID, _script: GDString | StringName | string, _supported: boolean): void;
  public font_get_script_support_override(_font_rid: RID, _script: GDString | StringName | string): boolean;
  public font_remove_script_support_override(_font_rid: RID, _script: GDString | StringName | string): void;
  ...
  public shaped_text_set_custom_punctuation(_shaped: RID, _punct: GDString | StringName | string): void;

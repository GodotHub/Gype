...
export declare class RDTextureView extends RefCounted{
  ...
  public set format_override(value: number): void {
    set_format_override(value);
  }
  public get swizzle_r(): number {
    get_swizzle_r();
  }
  public set swizzle_r(value: number): void {
    set_swizzle_r(value);
  }
  public get swizzle_g(): number {
    get_swizzle_g();
  }
  public set swizzle_g(value: number): void {
    set_swizzle_g(value);
  }
  public get swizzle_b(): number {
    get_swizzle_b();
  }
  public set swizzle_b(value: number): void {
    set_swizzle_b(value);
  }
  public get swizzle_a(): number {
    get_swizzle_a();
  }
  public set swizzle_a(value: number): void {
    set_swizzle_a(value);
  }
}
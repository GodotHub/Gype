...
export declare class IP extends Object{
  public resolve_hostname(_host: String, _ip_type: number): String;
  public resolve_hostname_addresses(_host: String, _ip_type: number): PackedStringArray;
  public resolve_hostname_queue_item(_host: String, _ip_type: number): number;

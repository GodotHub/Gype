...
export declare class IP extends GodotObject{
  public resolve_hostname(_host: GDString | StringName | string, _ip_type: number): String;
  public resolve_hostname_addresses(_host: GDString | StringName | string, _ip_type: number): PackedStringArray;
  public resolve_hostname_queue_item(_host: GDString | StringName | string, _ip_type: number): number;

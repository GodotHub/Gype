...
export declare class DirAccess extends RefCounted{
  public open(_path: GDString | StringName | string): DirAccess;
  ...
  public get_files_at(_path: GDString | StringName | string): PackedStringArray;
  public get_directories(): PackedStringArray;
  public get_directories_at(_path: GDString | StringName | string): PackedStringArray;
  ...
  public make_dir_absolute(_path: GDString | StringName | string): number;
  public make_dir_recursive(_path: GDString | StringName | string): number;
  public make_dir_recursive_absolute(_path: GDString | StringName | string): number;
  public file_exists(_path: GDString | StringName | string): boolean;
  public dir_exists(_path: GDString | StringName | string): boolean;
  public dir_exists_absolute(_path: GDString | StringName | string): boolean;
  public get_space_left(): number;
  public copy(_from: GDString | StringName | string, _to: GDString | StringName | string, _chmod_flags: number): number;
  public copy_absolute(_from: GDString | StringName | string, _to: GDString | StringName | string, _chmod_flags: number): number;
  public rename(_from: GDString | StringName | string, _to: GDString | StringName | string): number;
  public rename_absolute(_from: GDString | StringName | string, _to: GDString | StringName | string): number;
  public remove(_path: GDString | StringName | string): number;
  public remove_absolute(_path: GDString | StringName | string): number;

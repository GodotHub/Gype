...
export declare class Array {
  ...
  public find(_what: any, _from: number = 0): number;
  public rfind(_what: any, _from: number = -1): number;
  ...
  public shuffle(): void;
  public bsearch(_value: any, _before: boolean = true): number;
  public bsearch_custom(_value: any, _func: Callable, _before: boolean = true): number;
  public reverse(): void;
  public duplicate(_deep: boolean = false): GDArray;
  public slice(_begin: number, _end: number = 2147483647, _step: number = 1, _deep: boolean = false): GDArray;
  public filter(_method: Callable): GDArray;
  public map(_method: Callable): GDArray;
  public reduce(_method: Callable, _accum: any = null): any;

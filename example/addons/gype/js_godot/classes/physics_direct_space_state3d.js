...
export class PhysicsDirectSpaceState3D extends GodotObject{
  ...
  intersect_point(_parameters, _max_results) {
    PhysicsDirectSpaceState3D.init_method_intersect_point();
  ...
  intersect_ray(_parameters) {
    PhysicsDirectSpaceState3D.init_method_intersect_ray();
    return _call_native_mb_ret(
  ...
  intersect_shape(_parameters, _max_results) {
    PhysicsDirectSpaceState3D.init_method_intersect_shape();
    return _call_native_mb_ret(
  ...
  cast_motion(_parameters) {
    PhysicsDirectSpaceState3D.init_method_cast_motion();
    return _call_native_mb_ret(
  ...
  collide_shape(_parameters, _max_results) {
    PhysicsDirectSpaceState3D.init_method_collide_shape();
    return _call_native_mb_ret(
  ...
  get_rest_info(_parameters) {
    PhysicsDirectSpaceState3D.init_method_get_rest_info();
    return _call_native_mb_ret(

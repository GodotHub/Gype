...
export class RemoteTransform3D extends Node3D{
  ...
  static init_method_set_remote_node() {
    if (!this._bindings.method_set_remote_node) {
      let classname = new StringName("RemoteTransform3D");
  ...
  set_remote_node(_path) {
    RemoteTransform3D.init_method_set_remote_node();
  ...
  get_remote_node() {
    RemoteTransform3D.init_method_get_remote_node();
  ...
  force_update_cache() {
    RemoteTransform3D.init_method_force_update_cache();
    return _call_native_mb_no_ret(
  ...
  set_use_global_coordinates(_use_global_coordinates) {
    RemoteTransform3D.init_method_set_use_global_coordinates();
    return _call_native_mb_no_ret(
  ...
  get_use_global_coordinates() {
    RemoteTransform3D.init_method_get_use_global_coordinates();
    return _call_native_mb_ret(
  ...
  set_update_position(_update_remote_position) {
    RemoteTransform3D.init_method_set_update_position();
    return _call_native_mb_no_ret(
  ...
  get_update_position() {
    RemoteTransform3D.init_method_get_update_position();
    return _call_native_mb_ret(
  ...
  set_update_rotation(_update_remote_rotation) {
    RemoteTransform3D.init_method_set_update_rotation();
    return _call_native_mb_no_ret(
  ...
  get_update_rotation() {
    RemoteTransform3D.init_method_get_update_rotation();
    return _call_native_mb_ret(
  ...
  set_update_scale(_update_remote_scale) {
    RemoteTransform3D.init_method_set_update_scale();
    return _call_native_mb_no_ret(
  ...
  get_update_scale() {
    RemoteTransform3D.init_method_get_update_scale();
    return _call_native_mb_ret(

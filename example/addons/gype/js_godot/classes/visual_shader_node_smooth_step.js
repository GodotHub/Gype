...
export class VisualShaderNodeSmoothStep extends VisualShaderNode{
  ...
  constructor(godot_object) {
    if (!godot_object) {
      super("VisualShaderNodeSmoothStep");
    } else {
      super(godot_object);
    }
  }
  static init_method_set_op_type() {
    if (!this._bindings.method_set_op_type) {
      let classname = new StringName("VisualShaderNodeSmoothStep");
  ...
  set_op_type(_op_type) {
    VisualShaderNodeSmoothStep.init_method_set_op_type();
    return _call_native_mb_no_ret(
      VisualShaderNodeSmoothStep._bindings.method_set_op_type,
      this._owner,
      _op_type
    );
  ...
  get_op_type() {
    VisualShaderNodeSmoothStep.init_method_get_op_type();
    return _call_native_mb_ret(
      VisualShaderNodeSmoothStep._bindings.method_get_op_type,
      this._owner,
			Variant.Type.INT,

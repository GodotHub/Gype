...
export class GPUParticlesAttractorSphere3D extends GPUParticlesAttractor3D{
  ...
  set_radius(_radius) {
    GPUParticlesAttractorSphere3D.init_method_set_radius();
    return _call_native_mb_no_ret(
      GPUParticlesAttractorSphere3D._bindings.method_set_radius,
      this._owner,
      _radius
    );
  ...
  get_radius() {
    GPUParticlesAttractorSphere3D.init_method_get_radius();
    return _call_native_mb_ret(
      GPUParticlesAttractorSphere3D._bindings.method_get_radius,
      this._owner,
			Variant.Type.FLOAT,

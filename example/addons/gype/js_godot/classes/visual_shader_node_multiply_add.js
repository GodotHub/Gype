...
export class VisualShaderNodeMultiplyAdd extends VisualShaderNode{
  ...
  constructor(godot_object) {
    if (!godot_object) {
      super("VisualShaderNodeMultiplyAdd");
    } else {
      super(godot_object);
    }
  }
  static init_method_set_op_type() {
    if (!this._bindings.method_set_op_type) {
      let classname = new StringName("VisualShaderNodeMultiplyAdd");
  ...
  set_op_type(_type) {
    VisualShaderNodeMultiplyAdd.init_method_set_op_type();
    return _call_native_mb_no_ret(
      VisualShaderNodeMultiplyAdd._bindings.method_set_op_type,
      this._owner,
      _type
    );
  ...
  get_op_type() {
    VisualShaderNodeMultiplyAdd.init_method_get_op_type();
    return _call_native_mb_ret(
      VisualShaderNodeMultiplyAdd._bindings.method_get_op_type,
      this._owner,
			Variant.Type.INT,

...
export class VisualShaderNodeBooleanConstant extends VisualShaderNodeConstant{
  ...
  set_constant(_constant) {
    VisualShaderNodeBooleanConstant.init_method_set_constant();
    return _call_native_mb_no_ret(
      VisualShaderNodeBooleanConstant._bindings.method_set_constant,
      this._owner,
      _constant
    );
  ...
  get_constant() {
    VisualShaderNodeBooleanConstant.init_method_get_constant();
    return _call_native_mb_ret(
      VisualShaderNodeBooleanConstant._bindings.method_get_constant,
      this._owner,
			Variant.Type.BOOL,

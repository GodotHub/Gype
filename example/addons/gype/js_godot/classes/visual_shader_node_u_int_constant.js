...
export class VisualShaderNodeUIntConstant extends VisualShaderNodeConstant{
  ...
  set_constant(_constant) {
    VisualShaderNodeUIntConstant.init_method_set_constant();
    return _call_native_mb_no_ret(
      VisualShaderNodeUIntConstant._bindings.method_set_constant,
      this._owner,
      _constant
    );
  ...
  get_constant() {
    VisualShaderNodeUIntConstant.init_method_get_constant();
    return _call_native_mb_ret(
      VisualShaderNodeUIntConstant._bindings.method_get_constant,
      this._owner,
			Variant.Type.INT,

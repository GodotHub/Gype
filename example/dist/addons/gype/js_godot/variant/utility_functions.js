...
export class Random {
    ...
    static _init_bindings() {
        this.#randomize_func = variant_get_ptr_utility_function(new StringName("randomize").opaque, 1691721052);
        this.#randi_func = variant_get_ptr_utility_function(new StringName("randi").opaque, 701202648);
        this.#randf_func = variant_get_ptr_utility_function(new StringName("randf").opaque, 2086227845);
        this.#randi_range_func = variant_get_ptr_utility_function(new StringName("randi_range").opaque, 3133453818);
        this.#randf_range_func = variant_get_ptr_utility_function(new StringName("randf_range").opaque, 92296394);
        this.#randfn_func = variant_get_ptr_utility_function(new StringName("randfn").opaque, 92296394);
        this.#seed_func = variant_get_ptr_utility_function(new StringName("seed").opaque, 382931173);
        this.#rand_from_seed_func = variant_get_ptr_utility_function(new StringName("rand_from_seed").opaque, 1391063685);
    }
...
export class Math {
    ...
    static _init_bindings() {
        this.#sin_func = variant_get_ptr_utility_function(new StringName("sin").opaque, 2140049587);
        this.#cos_func = variant_get_ptr_utility_function(new StringName("cos").opaque, 2140049587);
        this.#tan_func = variant_get_ptr_utility_function(new StringName("tan").opaque, 2140049587);
        this.#sinh_func = variant_get_ptr_utility_function(new StringName("sinh").opaque, 2140049587);
        this.#cosh_func = variant_get_ptr_utility_function(new StringName("cosh").opaque, 2140049587);
        this.#tanh_func = variant_get_ptr_utility_function(new StringName("tanh").opaque, 2140049587);
        this.#asin_func = variant_get_ptr_utility_function(new StringName("asin").opaque, 2140049587);
        this.#acos_func = variant_get_ptr_utility_function(new StringName("acos").opaque, 2140049587);
        this.#atan_func = variant_get_ptr_utility_function(new StringName("atan").opaque, 2140049587);
        this.#atan2_func = variant_get_ptr_utility_function(new StringName("atan2").opaque, 92296394);
        this.#asinh_func = variant_get_ptr_utility_function(new StringName("asinh").opaque, 2140049587);
        this.#acosh_func = variant_get_ptr_utility_function(new StringName("acosh").opaque, 2140049587);
        this.#atanh_func = variant_get_ptr_utility_function(new StringName("atanh").opaque, 2140049587);
        this.#sqrt_func = variant_get_ptr_utility_function(new StringName("sqrt").opaque, 2140049587);
        this.#fmod_func = variant_get_ptr_utility_function(new StringName("fmod").opaque, 92296394);
        this.#fposmod_func = variant_get_ptr_utility_function(new StringName("fposmod").opaque, 92296394);
        this.#posmod_func = variant_get_ptr_utility_function(new StringName("posmod").opaque, 3133453818);
        this.#floor_func = variant_get_ptr_utility_function(new StringName("floor").opaque, 4776452);
        this.#floorf_func = variant_get_ptr_utility_function(new StringName("floorf").opaque, 2140049587);
        this.#floori_func = variant_get_ptr_utility_function(new StringName("floori").opaque, 2780425386);
        this.#ceil_func = variant_get_ptr_utility_function(new StringName("ceil").opaque, 4776452);
        this.#ceilf_func = variant_get_ptr_utility_function(new StringName("ceilf").opaque, 2140049587);
        this.#ceili_func = variant_get_ptr_utility_function(new StringName("ceili").opaque, 2780425386);
        this.#round_func = variant_get_ptr_utility_function(new StringName("round").opaque, 4776452);
        this.#roundf_func = variant_get_ptr_utility_function(new StringName("roundf").opaque, 2140049587);
        this.#roundi_func = variant_get_ptr_utility_function(new StringName("roundi").opaque, 2780425386);
        this.#abs_func = variant_get_ptr_utility_function(new StringName("abs").opaque, 4776452);
        this.#absf_func = variant_get_ptr_utility_function(new StringName("absf").opaque, 2140049587);
        this.#absi_func = variant_get_ptr_utility_function(new StringName("absi").opaque, 2157319888);
        this.#sign_func = variant_get_ptr_utility_function(new StringName("sign").opaque, 4776452);
        this.#signf_func = variant_get_ptr_utility_function(new StringName("signf").opaque, 2140049587);
        this.#signi_func = variant_get_ptr_utility_function(new StringName("signi").opaque, 2157319888);
        this.#snapped_func = variant_get_ptr_utility_function(new StringName("snapped").opaque, 459914704);
        this.#snappedf_func = variant_get_ptr_utility_function(new StringName("snappedf").opaque, 92296394);
        this.#snappedi_func = variant_get_ptr_utility_function(new StringName("snappedi").opaque, 3570758393);
        this.#pow_func = variant_get_ptr_utility_function(new StringName("pow").opaque, 92296394);
        this.#log_func = variant_get_ptr_utility_function(new StringName("log").opaque, 2140049587);
        this.#exp_func = variant_get_ptr_utility_function(new StringName("exp").opaque, 2140049587);
        this.#is_nan_func = variant_get_ptr_utility_function(new StringName("is_nan").opaque, 3569215213);
        this.#is_inf_func = variant_get_ptr_utility_function(new StringName("is_inf").opaque, 3569215213);
        this.#is_equal_approx_func = variant_get_ptr_utility_function(new StringName("is_equal_approx").opaque, 1400789633);
        this.#is_zero_approx_func = variant_get_ptr_utility_function(new StringName("is_zero_approx").opaque, 3569215213);
        this.#is_finite_func = variant_get_ptr_utility_function(new StringName("is_finite").opaque, 3569215213);
        this.#ease_func = variant_get_ptr_utility_function(new StringName("ease").opaque, 92296394);
        this.#step_decimals_func = variant_get_ptr_utility_function(new StringName("step_decimals").opaque, 2780425386);
        this.#lerp_func = variant_get_ptr_utility_function(new StringName("lerp").opaque, 3389874542);
        this.#lerpf_func = variant_get_ptr_utility_function(new StringName("lerpf").opaque, 998901048);
        this.#cubic_interpolate_func = variant_get_ptr_utility_function(new StringName("cubic_interpolate").opaque, 1090965791);
        this.#cubic_interpolate_angle_func = variant_get_ptr_utility_function(new StringName("cubic_interpolate_angle").opaque, 1090965791);
        this.#cubic_interpolate_in_time_func = variant_get_ptr_utility_function(new StringName("cubic_interpolate_in_time").opaque, 388121036);
        this.#cubic_interpolate_angle_in_time_func = variant_get_ptr_utility_function(new StringName("cubic_interpolate_angle_in_time").opaque, 388121036);
        this.#bezier_interpolate_func = variant_get_ptr_utility_function(new StringName("bezier_interpolate").opaque, 1090965791);
        this.#bezier_derivative_func = variant_get_ptr_utility_function(new StringName("bezier_derivative").opaque, 1090965791);
        this.#angle_difference_func = variant_get_ptr_utility_function(new StringName("angle_difference").opaque, 92296394);
        this.#lerp_angle_func = variant_get_ptr_utility_function(new StringName("lerp_angle").opaque, 998901048);
        this.#inverse_lerp_func = variant_get_ptr_utility_function(new StringName("inverse_lerp").opaque, 998901048);
        this.#remap_func = variant_get_ptr_utility_function(new StringName("remap").opaque, 1090965791);
        this.#smoothstep_func = variant_get_ptr_utility_function(new StringName("smoothstep").opaque, 998901048);
        this.#move_toward_func = variant_get_ptr_utility_function(new StringName("move_toward").opaque, 998901048);
        this.#rotate_toward_func = variant_get_ptr_utility_function(new StringName("rotate_toward").opaque, 998901048);
        this.#deg_to_rad_func = variant_get_ptr_utility_function(new StringName("deg_to_rad").opaque, 2140049587);
        this.#rad_to_deg_func = variant_get_ptr_utility_function(new StringName("rad_to_deg").opaque, 2140049587);
        this.#linear_to_db_func = variant_get_ptr_utility_function(new StringName("linear_to_db").opaque, 2140049587);
        this.#db_to_linear_func = variant_get_ptr_utility_function(new StringName("db_to_linear").opaque, 2140049587);
        this.#wrap_func = variant_get_ptr_utility_function(new StringName("wrap").opaque, 3389874542);
        this.#wrapi_func = variant_get_ptr_utility_function(new StringName("wrapi").opaque, 650295447);
        this.#wrapf_func = variant_get_ptr_utility_function(new StringName("wrapf").opaque, 998901048);
        this.#max_func = variant_get_ptr_utility_function(new StringName("max").opaque, 3896050336);
        this.#maxi_func = variant_get_ptr_utility_function(new StringName("maxi").opaque, 3133453818);
        this.#maxf_func = variant_get_ptr_utility_function(new StringName("maxf").opaque, 92296394);
        this.#min_func = variant_get_ptr_utility_function(new StringName("min").opaque, 3896050336);
        this.#mini_func = variant_get_ptr_utility_function(new StringName("mini").opaque, 3133453818);
        this.#minf_func = variant_get_ptr_utility_function(new StringName("minf").opaque, 92296394);
        this.#clamp_func = variant_get_ptr_utility_function(new StringName("clamp").opaque, 3389874542);
        this.#clampi_func = variant_get_ptr_utility_function(new StringName("clampi").opaque, 650295447);
        this.#clampf_func = variant_get_ptr_utility_function(new StringName("clampf").opaque, 998901048);
        this.#nearest_po2_func = variant_get_ptr_utility_function(new StringName("nearest_po2").opaque, 2157319888);
        this.#pingpong_func = variant_get_ptr_utility_function(new StringName("pingpong").opaque, 92296394);
    }
...
export class GD {
    ...
    static #is_same_func;
    static _init_bindings() {
        this.#weakref_func = variant_get_ptr_utility_function(new StringName("weakref").opaque, 4776452);
        this.#typeof_func = variant_get_ptr_utility_function(new StringName("typeof").opaque, 326422594);
        this.#type_convert_func = variant_get_ptr_utility_function(new StringName("type_convert").opaque, 2453062746);
        this.#str_func = variant_get_ptr_utility_function(new StringName("str").opaque, 32569176);
        this.#error_string_func = variant_get_ptr_utility_function(new StringName("error_string").opaque, 942708242);
        this.#type_string_func = variant_get_ptr_utility_function(new StringName("type_string").opaque, 942708242);
        this.#print_func = variant_get_ptr_utility_function(new StringName("print").opaque, 2648703342);
        this.#print_rich_func = variant_get_ptr_utility_function(new StringName("print_rich").opaque, 2648703342);
        this.#printerr_func = variant_get_ptr_utility_function(new StringName("printerr").opaque, 2648703342);
        this.#printt_func = variant_get_ptr_utility_function(new StringName("printt").opaque, 2648703342);
        this.#prints_func = variant_get_ptr_utility_function(new StringName("prints").opaque, 2648703342);
        this.#printraw_func = variant_get_ptr_utility_function(new StringName("printraw").opaque, 2648703342);
        this.#print_verbose_func = variant_get_ptr_utility_function(new StringName("print_verbose").opaque, 2648703342);
        this.#push_error_func = variant_get_ptr_utility_function(new StringName("push_error").opaque, 2648703342);
        this.#push_warning_func = variant_get_ptr_utility_function(new StringName("push_warning").opaque, 2648703342);
        this.#var_to_str_func = variant_get_ptr_utility_function(new StringName("var_to_str").opaque, 866625479);
        this.#str_to_var_func = variant_get_ptr_utility_function(new StringName("str_to_var").opaque, 1891498491);
        this.#var_to_bytes_func = variant_get_ptr_utility_function(new StringName("var_to_bytes").opaque, 2947269930);
        this.#bytes_to_var_func = variant_get_ptr_utility_function(new StringName("bytes_to_var").opaque, 4249819452);
        this.#var_to_bytes_with_objects_func = variant_get_ptr_utility_function(new StringName("var_to_bytes_with_objects").opaque, 2947269930);
        this.#bytes_to_var_with_objects_func = variant_get_ptr_utility_function(new StringName("bytes_to_var_with_objects").opaque, 4249819452);
        this.#hash_func = variant_get_ptr_utility_function(new StringName("hash").opaque, 326422594);
        this.#instance_from_id_func = variant_get_ptr_utility_function(new StringName("instance_from_id").opaque, 1156694636);
        this.#is_instance_id_valid_func = variant_get_ptr_utility_function(new StringName("is_instance_id_valid").opaque, 2232439758);
        this.#is_instance_valid_func = variant_get_ptr_utility_function(new StringName("is_instance_valid").opaque, 996128841);
        this.#rid_allocate_id_func = variant_get_ptr_utility_function(new StringName("rid_allocate_id").opaque, 701202648);
        this.#rid_from_int64_func = variant_get_ptr_utility_function(new StringName("rid_from_int64").opaque, 3426892196);
        this.#is_same_func = variant_get_ptr_utility_function(new StringName("is_same").opaque, 1409423524);
    }

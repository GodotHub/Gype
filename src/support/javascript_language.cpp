...
TypedArray<JavaScript> godot::JavaScriptLanguage::get_scripts() {
	TypedArray<JavaScript> r_arr;
	HashSet<Ref<JavaScript>>::Iterator it = JavaScriptLanguage::get_singleton()->scripts.begin();
	while (it) {
		r_arr.append(it->ptr());
		++it;
	}

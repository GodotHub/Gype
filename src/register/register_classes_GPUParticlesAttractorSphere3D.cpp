...
void register_classes_GPUParticlesAttractorSphere3D() {
    ...
    _module.class_<GPUParticlesAttractorSphere3D>("GPUParticlesAttractorSphere3D")
            ...
            .property<static_cast<double(GPUParticlesAttractorSphere3D::*)()const>(&GPUParticlesAttractorSphere3D::get_radius),static_cast<void(GPUParticlesAttractorSphere3D::*)(double)>(&GPUParticlesAttractorSphere3D::set_radius)>("radius")
;}
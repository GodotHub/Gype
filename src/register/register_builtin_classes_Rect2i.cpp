...
void register_builtin_classes_Rect2i() {
	...
	_Variant.class_<Rect2i>("Rect2i")
			.constructor<>()
			.constructor<const Rect2i &>("Rect2i_1")
			.constructor<const Rect2 &>("Rect2i_2")
			.constructor<const Vector2i &, const Vector2i &>("Rect2i_3")
			.constructor<int64_t, int64_t, int64_t, int64_t>("Rect2i_4")
			...
			.fun<static_cast<Rect2i (Rect2i::*)(godot::Side, int) const>(&Rect2i::grow_side)>("grow_side")

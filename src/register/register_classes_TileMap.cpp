...
void register_classes_TileMap() {
	...
	_module.class_<TileMap>("TileMap")
			...
			.property<&TileMap::get_rendering_quadrant_size, &TileMap::set_rendering_quadrant_size>("rendering_quadrant_size")
			.property<&TileMap::is_collision_animatable, &TileMap::set_collision_animatable>("collision_animatable")
			.property<&TileMap::get_collision_visibility_mode, &TileMap::set_collision_visibility_mode>("collision_visibility_mode")
			.property<&TileMap::get_navigation_visibility_mode, &TileMap::set_navigation_visibility_mode>("navigation_visibility_mode")

...
void register_builtin_classes_Quaternion() {
	...
	_Variant.class_<Quaternion>("Quaternion")
			.constructor<>()
			.constructor<const Quaternion &>("Quaternion_1")
			.constructor<const Basis &>("Quaternion_2")
			.constructor<const Vector3 &, real_t>("Quaternion_3")
			.constructor<const Vector3 &, const Vector3 &>("Quaternion_4")
			.constructor<real_t, real_t, real_t, real_t>("Quaternion_5")
			...
			.static_fun<static_cast<Quaternion (*)(const Vector3 &)>(&Quaternion::from_euler)>("from_euler")

...
void register_classes_SkeletonModification2D() {
    ...
    _module.class_<SkeletonModification2D>("SkeletonModification2D")
            .constructor<>()
            .base<Resource>()
            .property<static_cast<bool(SkeletonModification2D::*)()>(&SkeletonModification2D::get_enabled),static_cast<void(SkeletonModification2D::*)(bool)>(&SkeletonModification2D::set_enabled)>("enabled")
            .property<static_cast<int32_t(SkeletonModification2D::*)()const>(&SkeletonModification2D::get_execution_mode),static_cast<void(SkeletonModification2D::*)(int32_t)>(&SkeletonModification2D::set_execution_mode)>("execution_mode")

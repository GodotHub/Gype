...
void register_builtin_classes_Rect2() {
	get_Variant_module().class_<Rect2>("Rect2").constructor<>().constructor<const Rect2 &>("Rect2_1").constructor<const Rect2i &>("Rect2_2").constructor<const Vector2 &, const Vector2 &>("Rect2_3").constructor<real_t, real_t, real_t, real_t>("Rect2_4")

...
static JSValue visual_shader_node_vector_op_class_set_operator(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&VisualShaderNodeVectorOp::set_operator, ctx, this_val, argc, argv);
	return JS_UNDEFINED;
};
...
void define_visual_shader_node_vector_op_property(JSContext *ctx, JSValue obj) {

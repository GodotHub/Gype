...
static JSValue encoded_object_as_id_class_set_object_id(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&EncodedObjectAsID::set_object_id, EncodedObjectAsID::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue encoded_object_as_id_class_get_object_id(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&EncodedObjectAsID::get_object_id, EncodedObjectAsID::__class_id, ctx, this_val, argv);
};

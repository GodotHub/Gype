...
static JSValue visual_shader_node_vec3_constant_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	VisualShaderNodeVec3Constant *visual_shader_node_vec3_constant_class;
	if (argc == 1) 
		visual_shader_node_vec3_constant_class = static_cast<VisualShaderNodeVec3Constant *>(Variant(*argv).operator Object *());
	else 
		visual_shader_node_vec3_constant_class = memnew(VisualShaderNodeVec3Constant);
...
static int js_visual_shader_node_vec3_constant_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	constructors[VisualShaderNodeVec3Constant::__class_id] = ctor;

...
static JSValue visual_shader_node_transform_func_class_set_function(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&VisualShaderNodeTransformFunc::set_function, VisualShaderNodeTransformFunc::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_transform_func_class_get_function(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeTransformFunc::get_function, VisualShaderNodeTransformFunc::__class_id, ctx, this_val, argv);
};

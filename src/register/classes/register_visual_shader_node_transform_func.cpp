...
static JSClassDef visual_shader_node_transform_func_class_def = {
	...
	.finalizer = visual_shader_node_transform_func_class_finalizer
};
...
static int js_visual_shader_node_transform_func_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	constructors[VisualShaderNodeTransformFunc::__class_id] = ctor;
...
void register_visual_shader_node_transform_func() {
	VisualShaderNodeTransformFunc::__init_js_class_id();
	js_init_visual_shader_node_transform_func_module(ctx);
}
...
static JSValue visual_shader_node_rotation_by_axis_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	if (JS_IsException(obj))
		return obj;
	VisualShaderNodeRotationByAxis *visual_shader_node_rotation_by_axis_class = memnew(VisualShaderNodeRotationByAxis);
...
void define_visual_shader_node_rotation_by_axis_property(JSContext *ctx, JSValue obj) {
}

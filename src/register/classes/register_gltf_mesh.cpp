...
void define_gltf_mesh_property(JSContext *ctx, JSValue obj) {
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, gltf_mesh_class_set_original_name, "set_original_name", 0),
    ...
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, gltf_mesh_class_set_mesh, "set_mesh", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, gltf_mesh_class_set_blend_weights, "set_blend_weights", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, gltf_mesh_class_set_instance_materials, "set_instance_materials", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
}

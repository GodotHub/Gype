...
static void visual_shader_node_smooth_step_class_finalizer(JSRuntime *rt, JSValue val) {
	VisualShaderNodeSmoothStep *visual_shader_node_smooth_step = static_cast<VisualShaderNodeSmoothStep *>(JS_GetOpaque(val, VisualShaderNodeSmoothStep::__class_id));
	if (visual_shader_node_smooth_step)
		VisualShaderNodeSmoothStep::free(nullptr, visual_shader_node_smooth_step);
}
...
static JSValue visual_shader_node_smooth_step_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	JSValue obj = JS_NewObjectClass(ctx, VisualShaderNodeSmoothStep::__class_id);
...
static JSValue visual_shader_node_smooth_step_class_set_op_type(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&VisualShaderNodeSmoothStep::set_op_type, VisualShaderNodeSmoothStep::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_smooth_step_class_get_op_type(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeSmoothStep::get_op_type, VisualShaderNodeSmoothStep::__class_id, ctx, this_val, argv);
};

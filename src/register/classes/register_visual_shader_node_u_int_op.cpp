...
static void visual_shader_node_u_int_op_class_finalizer(JSRuntime *rt, JSValue val) {
	VisualShaderNodeUIntOp *visual_shader_node_u_int_op = static_cast<VisualShaderNodeUIntOp *>(JS_GetOpaque(val, VisualShaderNodeUIntOp::__class_id));
	if (visual_shader_node_u_int_op)
		VisualShaderNodeUIntOp::free(nullptr, visual_shader_node_u_int_op);
}
...
static JSValue visual_shader_node_u_int_op_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	VisualShaderNodeUIntOp *visual_shader_node_u_int_op_class;
	JSValue obj = JS_NewObjectClass(ctx, VisualShaderNodeUIntOp::__class_id);
	if (JS_IsException(obj))
		return obj;
	visual_shader_node_u_int_op_class = memnew(VisualShaderNodeUIntOp);
...
static JSValue visual_shader_node_u_int_op_class_set_operator(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&VisualShaderNodeUIntOp::set_operator, VisualShaderNodeUIntOp::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_u_int_op_class_get_operator(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeUIntOp::get_operator, VisualShaderNodeUIntOp::__class_id, ctx, this_val, argv);
};

...
static void physics_test_motion_parameters2d_class_finalizer(JSRuntime *rt, JSValue val) {
	...
	if (physics_test_motion_parameters2d)
		memdelete(physics_test_motion_parameters2d);
}
...
void define_physics_test_motion_parameters2d_property(JSContext *ctx, JSValue obj) {
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, physics_test_motion_parameters2d_class_set_from, "set_from", 0),
    ...
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, physics_test_motion_parameters2d_class_set_motion, "set_motion", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, physics_test_motion_parameters2d_class_set_margin, "set_margin", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, physics_test_motion_parameters2d_class_set_collide_separation_ray_enabled, "set_collide_separation_ray_enabled", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, physics_test_motion_parameters2d_class_set_exclude_bodies, "set_exclude_bodies", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, physics_test_motion_parameters2d_class_set_exclude_objects, "set_exclude_objects", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, physics_test_motion_parameters2d_class_set_recovery_as_collision_enabled, "set_recovery_as_collision_enabled", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
}

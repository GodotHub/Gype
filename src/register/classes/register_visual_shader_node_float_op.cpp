...
static void visual_shader_node_float_op_class_finalizer(JSRuntime *rt, JSValue val) {
	...
	if (visual_shader_node_float_op)
		VisualShaderNodeFloatOp::free(nullptr, visual_shader_node_float_op);
}
...
static JSValue visual_shader_node_float_op_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	VisualShaderNodeFloatOp *visual_shader_node_float_op_class;
	JSValue obj = JS_NewObjectClass(ctx, VisualShaderNodeFloatOp::__class_id);
	if (JS_IsException(obj))
		return obj;
	visual_shader_node_float_op_class = memnew(VisualShaderNodeFloatOp);
...
static JSValue visual_shader_node_float_op_class_set_operator(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&VisualShaderNodeFloatOp::set_operator, VisualShaderNodeFloatOp::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_float_op_class_get_operator(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeFloatOp::get_operator, VisualShaderNodeFloatOp::__class_id, ctx, this_val, argv);
};

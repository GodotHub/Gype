...
static JSValue quad_occluder3d_class_set_size(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&QuadOccluder3D::set_size, QuadOccluder3D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue quad_occluder3d_class_get_size(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&QuadOccluder3D::get_size, QuadOccluder3D::__class_id, ctx, this_val, argv);
};

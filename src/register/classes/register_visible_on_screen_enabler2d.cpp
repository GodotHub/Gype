...
static void visible_on_screen_enabler2d_class_finalizer(JSRuntime *rt, JSValue val) {
	VisibleOnScreenEnabler2D *visible_on_screen_enabler2d = static_cast<VisibleOnScreenEnabler2D *>(JS_GetOpaque(val, VisibleOnScreenEnabler2D::__class_id));
	if (visible_on_screen_enabler2d)
		VisibleOnScreenEnabler2D::free(nullptr, visible_on_screen_enabler2d);
}
...
static JSValue visible_on_screen_enabler2d_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	JSValue obj = JS_NewObjectClass(ctx, VisibleOnScreenEnabler2D::__class_id);
...
static JSValue visible_on_screen_enabler2d_class_set_enable_mode(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&VisibleOnScreenEnabler2D::set_enable_mode, VisibleOnScreenEnabler2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visible_on_screen_enabler2d_class_get_enable_mode(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_method_ret(&VisibleOnScreenEnabler2D::get_enable_mode, VisibleOnScreenEnabler2D::__class_id, ctx, this_val, argv);
};
static JSValue visible_on_screen_enabler2d_class_set_enable_node_path(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&VisibleOnScreenEnabler2D::set_enable_node_path, VisibleOnScreenEnabler2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visible_on_screen_enabler2d_class_get_enable_node_path(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_method_ret(&VisibleOnScreenEnabler2D::get_enable_node_path, VisibleOnScreenEnabler2D::__class_id, ctx, this_val, argv);
};

...
static JSValue input_event_gesture_class_set_position(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&InputEventGesture::set_position, InputEventGesture::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue input_event_gesture_class_get_position(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&InputEventGesture::get_position, InputEventGesture::__class_id, ctx, this_val, argv);
};

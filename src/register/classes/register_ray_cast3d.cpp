...
static JSValue ray_cast3d_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	if (JS_IsException(obj))
		return obj;
	RayCast3D *ray_cast3d_class = memnew(RayCast3D);
	if (!ray_cast3d_class) {
...
static JSValue ray_cast3d_class_get_target_position(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&RayCast3D::get_target_position, ctx, this_val, argc, argv);
};
...
static JSValue ray_cast3d_class_get_debug_shape_custom_color(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&RayCast3D::get_debug_shape_custom_color, ctx, this_val, argc, argv);
};
...
void define_ray_cast3d_property(JSContext *ctx, JSValue obj) {
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_enabled, "set_enabled", 0),
    ...
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_exclude_parent_body, "set_exclude_parent_body", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_target_position, "set_target_position", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_collision_mask, "set_collision_mask", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_hit_from_inside, "set_hit_from_inside", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_hit_back_faces, "set_hit_back_faces", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_collide_with_areas, "set_collide_with_areas", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_collide_with_bodies, "set_collide_with_bodies", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_debug_shape_custom_color, "set_debug_shape_custom_color", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, ray_cast3d_class_set_debug_shape_thickness, "set_debug_shape_thickness", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
}
...
static int js_ray_cast3d_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	class_id_list.insert(RayCast3D::__class_id);
	JS_NewClass(JS_GetRuntime(ctx), RayCast3D::__class_id, &ray_cast3d_class_def);

	JSValue proto = JS_NewObjectClass(ctx, RayCast3D::__class_id);

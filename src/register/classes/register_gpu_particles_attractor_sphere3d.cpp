...
static JSValue gpu_particles_attractor_sphere3d_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	if (JS_IsException(obj))
		return obj;
	GPUParticlesAttractorSphere3D *gpu_particles_attractor_sphere3d_class = memnew(GPUParticlesAttractorSphere3D);
...
static JSValue gpu_particles_attractor_sphere3d_class_set_radius(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    ...
    call_builtin_method_no_ret(&GPUParticlesAttractorSphere3D::set_radius, ctx, this_val, argc, argv);
	return JS_UNDEFINED;
};
...
void define_gpu_particles_attractor_sphere3d_property(JSContext *ctx, JSValue obj) {

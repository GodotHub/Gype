...
void define_navigation_path_query_parameters3d_property(JSContext *ctx, JSValue obj) {
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters3d_class_set_map, "set_map", 0),
    ...
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters3d_class_set_start_position, "set_start_position", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters3d_class_set_target_position, "set_target_position", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters3d_class_set_navigation_layers, "set_navigation_layers", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters3d_class_set_pathfinding_algorithm, "set_pathfinding_algorithm", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters3d_class_set_path_postprocessing, "set_path_postprocessing", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters3d_class_set_metadata_flags, "set_metadata_flags", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters3d_class_set_simplify_path, "set_simplify_path", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters3d_class_set_simplify_epsilon, "set_simplify_epsilon", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
}

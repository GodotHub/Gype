...
static JSValue visual_shader_node_vec4_constant_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	if (JS_IsException(obj))
		return obj;
	VisualShaderNodeVec4Constant *visual_shader_node_vec4_constant_class = memnew(VisualShaderNodeVec4Constant);
...
void define_visual_shader_node_vec4_constant_property(JSContext *ctx, JSValue obj) {
    JS_DefinePropertyGetSet(
        ctx,
        obj,
        JS_NewAtom(ctx, "constant"),
        JS_NewCFunction(ctx, visual_shader_node_vec4_constant_class_get_constant, "get_constant", 0),
        JS_NewCFunction(ctx, visual_shader_node_vec4_constant_class_set_constant, "set_constant", 0),
...
static int js_visual_shader_node_vec4_constant_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	JS_NewClassID(&VisualShaderNodeVec4Constant::__class_id);

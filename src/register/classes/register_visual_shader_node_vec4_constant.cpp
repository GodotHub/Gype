...
static JSValue visual_shader_node_vec4_constant_class_set_constant(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&VisualShaderNodeVec4Constant::set_constant, VisualShaderNodeVec4Constant::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_vec4_constant_class_get_constant(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeVec4Constant::get_constant, VisualShaderNodeVec4Constant::__class_id, ctx, this_val, argv);
};

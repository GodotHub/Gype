...
static JSValue audio_stream_playback_interactive_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	JSValue obj = JS_NewObjectProtoClass(ctx, proto, AudioStreamPlaybackInteractive::__class_id);
...
static void define_audio_stream_playback_interactive_enum(JSContext *ctx, JSValue proto) {
}
...
static int js_audio_stream_playback_interactive_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	JSValue proto = JS_NewObjectClass(ctx, AudioStreamPlaybackInteractive::__class_id);
	...
	define_audio_stream_playback_interactive_enum(ctx, proto);
	...
	constructors[AudioStreamPlaybackInteractive::__class_id] = ctor;

...
static JSValue visual_shader_node_compare_class_set_comparison_type(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&VisualShaderNodeCompare::set_comparison_type, VisualShaderNodeCompare::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_compare_class_get_comparison_type(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeCompare::get_comparison_type, VisualShaderNodeCompare::__class_id, ctx, this_val, argv);
};
static JSValue visual_shader_node_compare_class_set_function(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&VisualShaderNodeCompare::set_function, VisualShaderNodeCompare::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_compare_class_get_function(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeCompare::get_function, VisualShaderNodeCompare::__class_id, ctx, this_val, argv);
};
static JSValue visual_shader_node_compare_class_set_condition(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&VisualShaderNodeCompare::set_condition, VisualShaderNodeCompare::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_compare_class_get_condition(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeCompare::get_condition, VisualShaderNodeCompare::__class_id, ctx, this_val, argv);
};

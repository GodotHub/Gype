...
static void visual_shader_node_u_int_constant_class_finalizer(JSRuntime *rt, JSValue val) {
	VisualShaderNodeUIntConstant *visual_shader_node_u_int_constant = static_cast<VisualShaderNodeUIntConstant *>(JS_GetOpaque(val, VisualShaderNodeUIntConstant::__class_id));
	if (visual_shader_node_u_int_constant)
		VisualShaderNodeUIntConstant::free(nullptr, visual_shader_node_u_int_constant);
}
...
static JSValue visual_shader_node_u_int_constant_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	JSValue obj = JS_NewObjectClass(ctx, VisualShaderNodeUIntConstant::__class_id);
...
static JSValue visual_shader_node_u_int_constant_class_set_constant(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&VisualShaderNodeUIntConstant::set_constant, VisualShaderNodeUIntConstant::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_u_int_constant_class_get_constant(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeUIntConstant::get_constant, VisualShaderNodeUIntConstant::__class_id, ctx, this_val, argv);
};

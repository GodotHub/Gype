...
static JSValue visual_shader_node_screen_uv_to_sdf_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	if (JS_IsException(obj))
		return obj;
	VisualShaderNodeScreenUVToSDF *visual_shader_node_screen_uv_to_sdf_class = memnew(VisualShaderNodeScreenUVToSDF);
...
void define_visual_shader_node_screen_uv_to_sdf_property(JSContext *ctx, JSValue obj) {
}

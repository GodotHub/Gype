...
static JSValue visual_shader_node_transform_decompose_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	if (JS_IsException(obj))
		return obj;
	VisualShaderNodeTransformDecompose *visual_shader_node_transform_decompose_class = memnew(VisualShaderNodeTransformDecompose);
...
void define_visual_shader_node_transform_decompose_property(JSContext *ctx, JSValue obj) {
}

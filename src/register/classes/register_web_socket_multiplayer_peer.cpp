...
void define_web_socket_multiplayer_peer_property(JSContext *ctx, JSValue obj) {
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, web_socket_multiplayer_peer_class_set_supported_protocols, "set_supported_protocols", 0),
    ...
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, web_socket_multiplayer_peer_class_set_handshake_headers, "set_handshake_headers", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, web_socket_multiplayer_peer_class_set_inbound_buffer_size, "set_inbound_buffer_size", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, web_socket_multiplayer_peer_class_set_outbound_buffer_size, "set_outbound_buffer_size", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, web_socket_multiplayer_peer_class_set_handshake_timeout, "set_handshake_timeout", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, web_socket_multiplayer_peer_class_set_max_queued_packets, "set_max_queued_packets", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
}

...
static JSValue visible_on_screen_notifier2d_class_set_rect(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&VisibleOnScreenNotifier2D::set_rect, VisibleOnScreenNotifier2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visible_on_screen_notifier2d_class_get_rect(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisibleOnScreenNotifier2D::get_rect, VisibleOnScreenNotifier2D::__class_id, ctx, this_val, argv);
};
static JSValue visible_on_screen_notifier2d_class_is_on_screen(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisibleOnScreenNotifier2D::is_on_screen, VisibleOnScreenNotifier2D::__class_id, ctx, this_val, argv);
};

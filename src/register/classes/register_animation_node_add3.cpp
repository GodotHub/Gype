...
static void define_animation_node_add3_enum(JSContext *ctx, JSValue proto) {
}
...
static int js_animation_node_add3_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	define_animation_node_add3_enum(ctx, proto);
	...
	constructors[AnimationNodeAdd3::__class_id] = ctor;

...
static JSValue visual_shader_node_texture_sdf_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	if (JS_IsException(obj))
		return obj;
	VisualShaderNodeTextureSDF *visual_shader_node_texture_sdf_class = memnew(VisualShaderNodeTextureSDF);
...
void define_visual_shader_node_texture_sdf_property(JSContext *ctx, JSValue obj) {
}

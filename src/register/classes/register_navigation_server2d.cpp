...
static JSValue navigation_server2d_instance;
...
static void js_navigation_server2d_singleton() {
	if (JS_IsUninitialized(navigation_server2d_instance)) {
		JSValue global = JS_GetGlobalObject(ctx);
		navigation_server2d_instance = navigation_server2d_class_constructor(ctx, global, 0, NULL);

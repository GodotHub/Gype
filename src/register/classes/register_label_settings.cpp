...
static void define_label_settings_enum(JSContext *ctx, JSValue proto) {
}
...
static int js_label_settings_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	constructors[LabelSettings::__class_id] = ctor;

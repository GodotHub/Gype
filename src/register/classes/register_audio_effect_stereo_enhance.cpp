...
static JSValue audio_effect_stereo_enhance_class_set_pan_pullout(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&AudioEffectStereoEnhance::set_pan_pullout, AudioEffectStereoEnhance::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue audio_effect_stereo_enhance_class_get_pan_pullout(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&AudioEffectStereoEnhance::get_pan_pullout, AudioEffectStereoEnhance::__class_id, ctx, this_val, argv);
};
static JSValue audio_effect_stereo_enhance_class_set_time_pullout(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&AudioEffectStereoEnhance::set_time_pullout, AudioEffectStereoEnhance::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue audio_effect_stereo_enhance_class_get_time_pullout(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&AudioEffectStereoEnhance::get_time_pullout, AudioEffectStereoEnhance::__class_id, ctx, this_val, argv);
};
static JSValue audio_effect_stereo_enhance_class_set_surround(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&AudioEffectStereoEnhance::set_surround, AudioEffectStereoEnhance::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue audio_effect_stereo_enhance_class_get_surround(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&AudioEffectStereoEnhance::get_surround, AudioEffectStereoEnhance::__class_id, ctx, this_val, argv);
};

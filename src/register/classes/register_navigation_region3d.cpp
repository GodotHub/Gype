...
static void define_navigation_region3d_enum(JSContext *ctx, JSValue proto) {
}
...
static int js_navigation_region3d_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	define_navigation_region3d_enum(ctx, proto);
	...
	constructors[NavigationRegion3D::__class_id] = ctor;

...
static void physics_point_query_parameters3d_class_finalizer(JSRuntime *rt, JSValue val) {
	PhysicsPointQueryParameters3D *physics_point_query_parameters3d = static_cast<PhysicsPointQueryParameters3D *>(JS_GetOpaque(val, PhysicsPointQueryParameters3D::__class_id));
	if (physics_point_query_parameters3d)
		PhysicsPointQueryParameters3D::free(nullptr, physics_point_query_parameters3d);
}
...
static JSValue physics_point_query_parameters3d_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	JSValue obj = JS_NewObjectClass(ctx, PhysicsPointQueryParameters3D::__class_id);
...
static JSValue physics_point_query_parameters3d_class_set_position(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&PhysicsPointQueryParameters3D::set_position, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters3d_class_get_position(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters3D::get_position, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
};
static JSValue physics_point_query_parameters3d_class_set_collision_mask(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&PhysicsPointQueryParameters3D::set_collision_mask, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters3d_class_get_collision_mask(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters3D::get_collision_mask, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
};
static JSValue physics_point_query_parameters3d_class_set_exclude(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&PhysicsPointQueryParameters3D::set_exclude, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters3d_class_get_exclude(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters3D::get_exclude, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
};
static JSValue physics_point_query_parameters3d_class_set_collide_with_bodies(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&PhysicsPointQueryParameters3D::set_collide_with_bodies, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters3d_class_is_collide_with_bodies_enabled(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters3D::is_collide_with_bodies_enabled, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
};
static JSValue physics_point_query_parameters3d_class_set_collide_with_areas(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&PhysicsPointQueryParameters3D::set_collide_with_areas, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters3d_class_is_collide_with_areas_enabled(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters3D::is_collide_with_areas_enabled, PhysicsPointQueryParameters3D::__class_id, ctx, this_val, argv);
};

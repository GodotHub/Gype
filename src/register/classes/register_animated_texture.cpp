...
static void define_animated_texture_enum(JSContext *ctx, JSValue proto) {
}
...
static int js_animated_texture_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	define_animated_texture_enum(ctx, proto);
	...
	constructors[AnimatedTexture::__class_id] = ctor;

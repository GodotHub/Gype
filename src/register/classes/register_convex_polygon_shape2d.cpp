...
static JSValue convex_polygon_shape2d_class_set_point_cloud(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&ConvexPolygonShape2D::set_point_cloud, ConvexPolygonShape2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue convex_polygon_shape2d_class_set_points(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&ConvexPolygonShape2D::set_points, ConvexPolygonShape2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue convex_polygon_shape2d_class_get_points(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&ConvexPolygonShape2D::get_points, ConvexPolygonShape2D::__class_id, ctx, this_val, argv);
};

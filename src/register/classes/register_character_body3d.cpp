...
static JSValue character_body3d_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	JSValue obj = JS_NewObjectProtoClass(ctx, proto, CharacterBody3D::__class_id);
	if (JS_IsException(obj))
		return obj;
	CharacterBody3D *character_body3d_class = memnew(CharacterBody3D);
...
void define_character_body3d_property(JSContext *ctx, JSValue obj) {
    JS_DefinePropertyGetSet(
        ctx,
        obj,
        JS_NewAtom(ctx, "motion_mode"),
        JS_NewCFunction(ctx, character_body3d_class_get_motion_mode, "get_motion_mode", 0),
        JS_NewCFunction(ctx, character_body3d_class_set_motion_mode, "set_motion_mode", 0),
    ...
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_up_direction, "set_up_direction", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_slide_on_ceiling_enabled, "set_slide_on_ceiling_enabled", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_velocity, "set_velocity", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_max_slides, "set_max_slides", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_wall_min_slide_angle, "set_wall_min_slide_angle", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_floor_stop_on_slope_enabled, "set_floor_stop_on_slope_enabled", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_floor_constant_speed_enabled, "set_floor_constant_speed_enabled", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_floor_block_on_wall_enabled, "set_floor_block_on_wall_enabled", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_floor_max_angle, "set_floor_max_angle", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_floor_snap_length, "set_floor_snap_length", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_platform_on_leave, "set_platform_on_leave", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_platform_floor_layers, "set_platform_floor_layers", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_platform_wall_layers, "set_platform_wall_layers", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, character_body3d_class_set_safe_margin, "set_safe_margin", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
}
...
static int js_character_body3d_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	class_id_list.insert(CharacterBody3D::__class_id);
	JS_NewClass(JS_GetRuntime(ctx), CharacterBody3D::__class_id, &character_body3d_class_def);

	JSValue proto = JS_NewObjectClass(ctx, CharacterBody3D::__class_id);
...
void register_character_body3d() {
	CharacterBody3D::__init_js_class_id();

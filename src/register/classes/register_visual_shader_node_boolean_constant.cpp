...
static JSValue visual_shader_node_boolean_constant_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	if (JS_IsException(obj))
		return obj;
	VisualShaderNodeBooleanConstant *visual_shader_node_boolean_constant_class = memnew(VisualShaderNodeBooleanConstant);
...
static JSValue visual_shader_node_boolean_constant_class_set_constant(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&VisualShaderNodeBooleanConstant::set_constant, ctx, this_val, argc, argv);
	return JS_UNDEFINED;
};
...
void define_visual_shader_node_boolean_constant_property(JSContext *ctx, JSValue obj) {
    JS_DefinePropertyGetSet(
        ctx,
        obj,
        JS_NewAtom(ctx, "constant"),
        JS_NewCFunction(ctx, visual_shader_node_boolean_constant_class_get_constant, "get_constant", 0),
        JS_NewCFunction(ctx, visual_shader_node_boolean_constant_class_set_constant, "set_constant", 0),

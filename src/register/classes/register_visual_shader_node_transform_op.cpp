...
static void visual_shader_node_transform_op_class_finalizer(JSRuntime *rt, JSValue val) {
	VisualShaderNodeTransformOp *visual_shader_node_transform_op = static_cast<VisualShaderNodeTransformOp *>(JS_GetOpaque(val, VisualShaderNodeTransformOp::__class_id));
	if (visual_shader_node_transform_op)
		VisualShaderNodeTransformOp::free(nullptr, visual_shader_node_transform_op);
}
...
static JSValue visual_shader_node_transform_op_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	JSValue obj = JS_NewObjectClass(ctx, VisualShaderNodeTransformOp::__class_id);
...
static JSValue visual_shader_node_transform_op_class_set_operator(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&VisualShaderNodeTransformOp::set_operator, VisualShaderNodeTransformOp::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue visual_shader_node_transform_op_class_get_operator(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&VisualShaderNodeTransformOp::get_operator, VisualShaderNodeTransformOp::__class_id, ctx, this_val, argv);
};

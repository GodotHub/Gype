...
static void visual_shader_node_color_parameter_class_finalizer(JSRuntime *rt, JSValue val) {
	...
	if (visual_shader_node_color_parameter)
		memdelete(visual_shader_node_color_parameter);
}
...
void define_visual_shader_node_color_parameter_property(JSContext *ctx, JSValue obj) {
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, visual_shader_node_color_parameter_class_set_default_value_enabled, "set_default_value_enabled", 0),
    ...
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, visual_shader_node_color_parameter_class_set_default_value, "set_default_value", 0),
        JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE
    );
}

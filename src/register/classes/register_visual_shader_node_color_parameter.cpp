...
static void define_visual_shader_node_color_parameter_enum(JSContext *ctx, JSValue proto) {
}
...
static int js_visual_shader_node_color_parameter_class_init(JSContext *ctx, JSModuleDef *m) {
	...
	define_visual_shader_node_color_parameter_enum(ctx, proto);
	...
	constructors[VisualShaderNodeColorParameter::__class_id] = ctor;

...
static void physics_point_query_parameters2d_class_finalizer(JSRuntime *rt, JSValue val) {
	...
	if (physics_point_query_parameters2d)
		PhysicsPointQueryParameters2D::free(nullptr, physics_point_query_parameters2d);
}
...
static JSValue physics_point_query_parameters2d_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	...
	JSValue obj = JS_NewObjectClass(ctx, PhysicsPointQueryParameters2D::__class_id);
...
static JSValue physics_point_query_parameters2d_class_set_position(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&PhysicsPointQueryParameters2D::set_position, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters2d_class_get_position(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters2D::get_position, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
};
static JSValue physics_point_query_parameters2d_class_set_canvas_instance_id(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&PhysicsPointQueryParameters2D::set_canvas_instance_id, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters2d_class_get_canvas_instance_id(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters2D::get_canvas_instance_id, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
};
static JSValue physics_point_query_parameters2d_class_set_collision_mask(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&PhysicsPointQueryParameters2D::set_collision_mask, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters2d_class_get_collision_mask(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters2D::get_collision_mask, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
};
static JSValue physics_point_query_parameters2d_class_set_exclude(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&PhysicsPointQueryParameters2D::set_exclude, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters2d_class_get_exclude(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters2D::get_exclude, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
};
static JSValue physics_point_query_parameters2d_class_set_collide_with_bodies(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&PhysicsPointQueryParameters2D::set_collide_with_bodies, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters2d_class_is_collide_with_bodies_enabled(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters2D::is_collide_with_bodies_enabled, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
};
static JSValue physics_point_query_parameters2d_class_set_collide_with_areas(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	call_builtin_method_no_ret(&PhysicsPointQueryParameters2D::set_collide_with_areas, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
	return JS_UNDEFINED;
};
static JSValue physics_point_query_parameters2d_class_is_collide_with_areas_enabled(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&PhysicsPointQueryParameters2D::is_collide_with_areas_enabled, PhysicsPointQueryParameters2D::__class_id, ctx, this_val, argv);
};
...
static int js_physics_point_query_parameters2d_class_init(JSContext *ctx, JSModuleDef *m) {
	JS_NewClassID(&PhysicsPointQueryParameters2D::__class_id);

...
void register_builtin_classes_Basis() {
	...
	_Variant.class_<Basis>("Basis")
			.constructor<>()
			.constructor<const Basis &>("Basis_1")
			.constructor<const Quaternion &>("Basis_2")
			.constructor<const Vector3 &, real_t>("Basis_3")
			.constructor<const Vector3 &, const Vector3 &, const Vector3 &>("Basis_4")
			...
			.fun<static_cast<Vector3 (Basis::*)(godot::EulerOrder) const>(&Basis::get_euler)>("get_euler")
			...
			.static_fun<static_cast<Basis (*)(const Vector3 &, const Vector3 &, bool)>(&Basis::looking_at)>("looking_at")
			.static_fun<static_cast<Basis (*)(const Vector3 &)>(&Basis::from_scale)>("from_scale")
			.static_fun<static_cast<Basis (*)(const Vector3 &, godot::EulerOrder)>(&Basis::from_euler)>("from_euler");
}
...
void register_classes_TextParagraph() {
    ...
    _module.class_<TextParagraph>("TextParagraph")
            .constructor<>()
            .base<RefCounted>()
            .property<static_cast<TextServer::Direction(TextParagraph::*)()const>(&TextParagraph::get_direction),static_cast<void(TextParagraph::*)(TextServer::Direction)>(&TextParagraph::set_direction)>("direction")
            .property<static_cast<String(TextParagraph::*)()const>(&TextParagraph::get_custom_punctuation),static_cast<void(TextParagraph::*)(const String &)>(&TextParagraph::set_custom_punctuation)>("custom_punctuation")
            .property<static_cast<TextServer::Orientation(TextParagraph::*)()const>(&TextParagraph::get_orientation),static_cast<void(TextParagraph::*)(TextServer::Orientation)>(&TextParagraph::set_orientation)>("orientation")
            .property<static_cast<bool(TextParagraph::*)()const>(&TextParagraph::get_preserve_invalid),static_cast<void(TextParagraph::*)(bool)>(&TextParagraph::set_preserve_invalid)>("preserve_invalid")
            .property<static_cast<bool(TextParagraph::*)()const>(&TextParagraph::get_preserve_control),static_cast<void(TextParagraph::*)(bool)>(&TextParagraph::set_preserve_control)>("preserve_control")
            .property<static_cast<HorizontalAlignment(TextParagraph::*)()const>(&TextParagraph::get_alignment),static_cast<void(TextParagraph::*)(HorizontalAlignment)>(&TextParagraph::set_alignment)>("alignment")
            .property<static_cast<BitField<TextServer::LineBreakFlag>(TextParagraph::*)()const>(&TextParagraph::get_break_flags),static_cast<void(TextParagraph::*)(BitField<TextServer::LineBreakFlag>)>(&TextParagraph::set_break_flags)>("break_flags")
            .property<static_cast<BitField<TextServer::JustificationFlag>(TextParagraph::*)()const>(&TextParagraph::get_justification_flags),static_cast<void(TextParagraph::*)(BitField<TextServer::JustificationFlag>)>(&TextParagraph::set_justification_flags)>("justification_flags")
            .property<static_cast<TextServer::OverrunBehavior(TextParagraph::*)()const>(&TextParagraph::get_text_overrun_behavior),static_cast<void(TextParagraph::*)(TextServer::OverrunBehavior)>(&TextParagraph::set_text_overrun_behavior)>("text_overrun_behavior")
            .property<static_cast<String(TextParagraph::*)()const>(&TextParagraph::get_ellipsis_char),static_cast<void(TextParagraph::*)(const String &)>(&TextParagraph::set_ellipsis_char)>("ellipsis_char")
            .property<static_cast<double(TextParagraph::*)()const>(&TextParagraph::get_width),static_cast<void(TextParagraph::*)(double)>(&TextParagraph::set_width)>("width")
            .property<static_cast<int32_t(TextParagraph::*)()const>(&TextParagraph::get_max_lines_visible),static_cast<void(TextParagraph::*)(int32_t)>(&TextParagraph::set_max_lines_visible)>("max_lines_visible")

...
void register_classes_SurfaceTool() {
    ...
    _module.class_<SurfaceTool>("SurfaceTool")
            ...
            .fun<static_cast<void(SurfaceTool::*)(const Array &,Mesh::PrimitiveType)>(&SurfaceTool::create_from_arrays)>("create_from_arrays")
...
;    qjs::Value _CustomFormat = context->newObject();
    _CustomFormat["CUSTOM_RGBA8_UNORM"] = SurfaceTool::CustomFormat::CUSTOM_RGBA8_UNORM;
    _CustomFormat["CUSTOM_RGBA8_SNORM"] = SurfaceTool::CustomFormat::CUSTOM_RGBA8_SNORM;
    _CustomFormat["CUSTOM_RG_HALF"] = SurfaceTool::CustomFormat::CUSTOM_RG_HALF;
    _CustomFormat["CUSTOM_RGBA_HALF"] = SurfaceTool::CustomFormat::CUSTOM_RGBA_HALF;
    _CustomFormat["CUSTOM_R_FLOAT"] = SurfaceTool::CustomFormat::CUSTOM_R_FLOAT;
    _CustomFormat["CUSTOM_RG_FLOAT"] = SurfaceTool::CustomFormat::CUSTOM_RG_FLOAT;
    _CustomFormat["CUSTOM_RGB_FLOAT"] = SurfaceTool::CustomFormat::CUSTOM_RGB_FLOAT;
    _CustomFormat["CUSTOM_RGBA_FLOAT"] = SurfaceTool::CustomFormat::CUSTOM_RGBA_FLOAT;
    _CustomFormat["CUSTOM_MAX"] = SurfaceTool::CustomFormat::CUSTOM_MAX;
    _module.add("CustomFormat", std::move(_CustomFormat));
    qjs::Value _SkinWeightCount = context->newObject();
    _SkinWeightCount["SKIN_4_WEIGHTS"] = SurfaceTool::SkinWeightCount::SKIN_4_WEIGHTS;
    _SkinWeightCount["SKIN_8_WEIGHTS"] = SurfaceTool::SkinWeightCount::SKIN_8_WEIGHTS;

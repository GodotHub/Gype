...
void register_classes_AnimationNode() {
    ...
    _module.class_<AnimationNode>("AnimationNode")
            .constructor<>()
            .base<Resource>()
            .property<static_cast<bool(AnimationNode::*)()const>(&AnimationNode::is_filter_enabled),static_cast<void(AnimationNode::*)(bool)>(&AnimationNode::set_filter_enabled)>("filter_enabled")
...
;    qjs::Value _FilterAction = context->newObject();
    _FilterAction["FILTER_IGNORE"] = AnimationNode::FilterAction::FILTER_IGNORE;
    _FilterAction["FILTER_PASS"] = AnimationNode::FilterAction::FILTER_PASS;
    _FilterAction["FILTER_STOP"] = AnimationNode::FilterAction::FILTER_STOP;
    _FilterAction["FILTER_BLEND"] = AnimationNode::FilterAction::FILTER_BLEND;

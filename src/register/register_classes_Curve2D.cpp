...
void register_classes_Curve2D() {
    ...
    _module.class_<Curve2D>("Curve2D")
            .constructor<>()
            .base<Resource>()
            .property<static_cast<double(Curve2D::*)()const>(&Curve2D::get_bake_interval),static_cast<void(Curve2D::*)(double)>(&Curve2D::set_bake_interval)>("bake_interval")
            .property<static_cast<int32_t(Curve2D::*)()const>(&Curve2D::get_point_count),static_cast<void(Curve2D::*)(int32_t)>(&Curve2D::set_point_count)>("point_count")

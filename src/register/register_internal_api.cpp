...
void register_internal_api() {
	...
	_module.function("get_godot_version", [](GDExtensionGodotVersion *r_godot_version) {
			   godot::internal::gdextension_interface_get_godot_version(r_godot_version);
		   })
			.function("print_error", [](const char *p_description, const char *p_function, const char *p_file, int32_t p_line, GDExtensionBool p_editor_notify) {
				godot::internal::gdextension_interface_print_error(p_description, p_function, p_file, p_line, p_editor_notify);
			})
			...
			.function("string_name_new_with_latin1_chars", [](Buff r_dest, const char *p_contents, GDExtensionBool p_is_static = false) {
				godot::internal::gdextension_interface_string_name_new_with_latin1_chars(
			...
			.function("variant_get_ptr_builtin_method", [](GDExtensionVariantType p_type, Buff p_method, GDExtensionInt p_hash) -> GDExtensionPtrBuiltInMethod {
				return godot::internal::gdextension_interface_variant_get_ptr_builtin_method(p_type, qjs::get_typed_array_buf(context.ctx, p_method), p_hash);
			})
			...
			.function("variant_new_nil", [](Buff r_dest) {
				godot::internal::gdextension_interface_variant_new_nil(qjs::get_typed_array_buf(context.ctx, r_dest));
			})
			...
			.function("variant_destroy", [](GDExtensionVariantPtr p_self) { godot::internal::gdextension_interface_variant_destroy(p_self); })
			...
			.function("object_method_bind_ptrcall", [](Pointer p_method_bind, Pointer p_instance, GDExtensionVariantType type, qjs::rest<JSValue> args) {
				...
				godot::internal::gdextension_interface_object_method_bind_ptrcall(qjs::to_c_pointer(context.ctx, p_method_bind), qjs::to_c_pointer(context.ctx, p_instance), p_args, r_ret);
			...
			.function("classdb_construct_object", [](Buff p_classname) -> GDExtensionObjectPtr {
				return godot::internal::gdextension_interface_classdb_construct_object(qjs::get_typed_array_buf(context.ctx, p_classname));
			})
			.function("object_set_instance", [](GDExtensionObjectPtr p_o, GDString p_classname, GDExtensionClassInstancePtr p_instance) {
				godot::internal::gdextension_interface_object_set_instance(p_o, qjs::get_typed_array_buf(context.ctx, p_classname), p_instance);
			})

...
void register_classes_ArrayMesh() {
    ...
    _module.class_<ArrayMesh>("ArrayMesh")
            .constructor<>()
            .base<Mesh>()
            .property<static_cast<Mesh::BlendShapeMode(ArrayMesh::*)()const>(&ArrayMesh::get_blend_shape_mode),static_cast<void(ArrayMesh::*)(Mesh::BlendShapeMode)>(&ArrayMesh::set_blend_shape_mode)>("blend_shape_mode")
            .property<static_cast<AABB(ArrayMesh::*)()const>(&ArrayMesh::get_custom_aabb),static_cast<void(ArrayMesh::*)(const AABB &)>(&ArrayMesh::set_custom_aabb)>("custom_aabb")
            .property<static_cast<Ref<ArrayMesh>(ArrayMesh::*)()const>(&ArrayMesh::get_shadow_mesh),static_cast<void(ArrayMesh::*)(const Ref<ArrayMesh> &)>(&ArrayMesh::set_shadow_mesh)>("shadow_mesh")

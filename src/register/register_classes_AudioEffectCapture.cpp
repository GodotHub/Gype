...
void register_classes_AudioEffectCapture() {
    ...
    _module.class_<AudioEffectCapture>("AudioEffectCapture")
            .constructor<>()
            .base<AudioEffect>()
            .property<static_cast<double(AudioEffectCapture::*)()>(&AudioEffectCapture::get_buffer_length),static_cast<void(AudioEffectCapture::*)(double)>(&AudioEffectCapture::set_buffer_length)>("buffer_length")

...
void register_classes_Skeleton3D() {
    ...
    _module.class_<Skeleton3D>("Skeleton3D")
            .constructor<>()
            .base<Node3D>()
            .static_fun<&Skeleton3D::NOTIFICATION_UPDATE_SKELETON>("NOTIFICATION_UPDATE_SKELETON")
            .property<static_cast<double(Skeleton3D::*)()const>(&Skeleton3D::get_motion_scale),static_cast<void(Skeleton3D::*)(double)>(&Skeleton3D::set_motion_scale)>("motion_scale")
            .property<static_cast<bool(Skeleton3D::*)()const>(&Skeleton3D::is_show_rest_only),static_cast<void(Skeleton3D::*)(bool)>(&Skeleton3D::set_show_rest_only)>("show_rest_only")
            .property<static_cast<Skeleton3D::ModifierCallbackModeProcess(Skeleton3D::*)()const>(&Skeleton3D::get_modifier_callback_mode_process),static_cast<void(Skeleton3D::*)(Skeleton3D::ModifierCallbackModeProcess)>(&Skeleton3D::set_modifier_callback_mode_process)>("modifier_callback_mode_process")
            ...
            .fun<static_cast<void(Skeleton3D::*)(int32_t,const Transform3D &)>(&Skeleton3D::set_bone_pose)>("set_bone_pose")
            ...
            .fun<static_cast<void(Skeleton3D::*)(int32_t,const Transform3D &)>(&Skeleton3D::set_bone_global_pose)>("set_bone_global_pose")
            ...
            .fun<static_cast<void(Skeleton3D::*)(bool)>(&Skeleton3D::set_animate_physical_bones)>("set_animate_physical_bones")
            .fun<static_cast<bool(Skeleton3D::*)()const>(&Skeleton3D::get_animate_physical_bones)>("get_animate_physical_bones")
...
;    qjs::Value _ModifierCallbackModeProcess = context->newObject();
    _ModifierCallbackModeProcess["MODIFIER_CALLBACK_MODE_PROCESS_PHYSICS"] = Skeleton3D::ModifierCallbackModeProcess::MODIFIER_CALLBACK_MODE_PROCESS_PHYSICS;
    _ModifierCallbackModeProcess["MODIFIER_CALLBACK_MODE_PROCESS_IDLE"] = Skeleton3D::ModifierCallbackModeProcess::MODIFIER_CALLBACK_MODE_PROCESS_IDLE;

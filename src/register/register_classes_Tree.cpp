...
void register_classes_Tree() {
    ...
    _module.class_<Tree>("Tree")
            .constructor<>()
            .base<Control>()
            .property<static_cast<int32_t(Tree::*)()const>(&Tree::get_columns),static_cast<void(Tree::*)(int32_t)>(&Tree::set_columns)>("columns")
            .property<static_cast<bool(Tree::*)()const>(&Tree::are_column_titles_visible),static_cast<void(Tree::*)(bool)>(&Tree::set_column_titles_visible)>("column_titles_visible")
            .property<static_cast<bool(Tree::*)()const>(&Tree::get_allow_reselect),static_cast<void(Tree::*)(bool)>(&Tree::set_allow_reselect)>("allow_reselect")
            .property<static_cast<bool(Tree::*)()const>(&Tree::get_allow_rmb_select),static_cast<void(Tree::*)(bool)>(&Tree::set_allow_rmb_select)>("allow_rmb_select")
            .property<static_cast<bool(Tree::*)()const>(&Tree::get_allow_search),static_cast<void(Tree::*)(bool)>(&Tree::set_allow_search)>("allow_search")
            .property<static_cast<bool(Tree::*)()const>(&Tree::is_folding_hidden),static_cast<void(Tree::*)(bool)>(&Tree::set_hide_folding)>("hide_folding")
            .property<static_cast<bool(Tree::*)()const>(&Tree::is_recursive_folding_enabled),static_cast<void(Tree::*)(bool)>(&Tree::set_enable_recursive_folding)>("enable_recursive_folding")
            .property<static_cast<bool(Tree::*)()const>(&Tree::is_root_hidden),static_cast<void(Tree::*)(bool)>(&Tree::set_hide_root)>("hide_root")
            .property<static_cast<int32_t(Tree::*)()const>(&Tree::get_drop_mode_flags),static_cast<void(Tree::*)(int32_t)>(&Tree::set_drop_mode_flags)>("drop_mode_flags")
            .property<static_cast<Tree::SelectMode(Tree::*)()const>(&Tree::get_select_mode),static_cast<void(Tree::*)(Tree::SelectMode)>(&Tree::set_select_mode)>("select_mode")
            .property<static_cast<bool(Tree::*)()const>(&Tree::is_h_scroll_enabled),static_cast<void(Tree::*)(bool)>(&Tree::set_h_scroll_enabled)>("scroll_horizontal_enabled")
            .property<static_cast<bool(Tree::*)()const>(&Tree::is_v_scroll_enabled),static_cast<void(Tree::*)(bool)>(&Tree::set_v_scroll_enabled)>("scroll_vertical_enabled")
...
;    qjs::Value _SelectMode = context->newObject();
    _SelectMode["SELECT_SINGLE"] = Tree::SelectMode::SELECT_SINGLE;
    _SelectMode["SELECT_ROW"] = Tree::SelectMode::SELECT_ROW;
    _SelectMode["SELECT_MULTI"] = Tree::SelectMode::SELECT_MULTI;
    _module.add("SelectMode", std::move(_SelectMode));
    qjs::Value _DropModeFlags = context->newObject();
    _DropModeFlags["DROP_MODE_DISABLED"] = Tree::DropModeFlags::DROP_MODE_DISABLED;
    _DropModeFlags["DROP_MODE_ON_ITEM"] = Tree::DropModeFlags::DROP_MODE_ON_ITEM;
    _DropModeFlags["DROP_MODE_INBETWEEN"] = Tree::DropModeFlags::DROP_MODE_INBETWEEN;

...
void register_classes_NavigationPolygon() {
    ...
    _module.class_<NavigationPolygon>("NavigationPolygon")
           ...
           .property<NavigationPolygon::_get_polygons, NavigationPolygon::_set_polygons>("polygons")
           .property<NavigationPolygon::_get_outlines, NavigationPolygon::_set_outlines>("outlines")

...
void register_classes_SphereOccluder3D() {
    ...
    _module.class_<SphereOccluder3D>("SphereOccluder3D")
            .constructor<>()
            .base<Occluder3D>()
            .property<static_cast<double(SphereOccluder3D::*)()const>(&SphereOccluder3D::get_radius),static_cast<void(SphereOccluder3D::*)(double)>(&SphereOccluder3D::set_radius)>("radius")
;}
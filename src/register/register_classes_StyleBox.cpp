...
void register_classes_StyleBox() {
    ...
    _module.class_<StyleBox>("StyleBox")
            .constructor<>()
            .base<Resource>()
            .property<static_cast<double(StyleBox::*)(Side)const>(&StyleBox::get_content_margin),static_cast<void(StyleBox::*)(Side,double)>(&StyleBox::set_content_margin)>("content_margin_left")
            .property<static_cast<double(StyleBox::*)(Side)const>(&StyleBox::get_content_margin),static_cast<void(StyleBox::*)(Side,double)>(&StyleBox::set_content_margin)>("content_margin_top")
            .property<static_cast<double(StyleBox::*)(Side)const>(&StyleBox::get_content_margin),static_cast<void(StyleBox::*)(Side,double)>(&StyleBox::set_content_margin)>("content_margin_right")
            .property<static_cast<double(StyleBox::*)(Side)const>(&StyleBox::get_content_margin),static_cast<void(StyleBox::*)(Side,double)>(&StyleBox::set_content_margin)>("content_margin_bottom")

...
static void vector3_class_finalizer(JSRuntime *rt, JSValue val) {
	...
	Vector3 *vector3 = static_cast<Vector3 *>(JS_GetOpaque(val, class_id));
	if (vector3)
		memfree(vector3);
}
...
static JSValue vector3_class_get_x(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	Vector3 &val = *reinterpret_cast<Vector3 *>(JS_GetOpaque(this_val, classes["Vector3"]));
...
void define_vector3_constants(JSContext *ctx, JSValue ctor) {
	...
	JS_DefinePropertyValueStr(ctx, ctor, "ZERO", VariantAdapter(Vector3(0, 0, 0)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "ONE", VariantAdapter(Vector3(1, 1, 1)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "INF", VariantAdapter(Vector3(INFINITY, INFINITY, INFINITY)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "LEFT", VariantAdapter(Vector3(-1, 0, 0)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "RIGHT", VariantAdapter(Vector3(1, 0, 0)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "UP", VariantAdapter(Vector3(0, 1, 0)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "DOWN", VariantAdapter(Vector3(0, -1, 0)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "FORWARD", VariantAdapter(Vector3(0, 0, -1)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "BACK", VariantAdapter(Vector3(0, 0, 1)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "MODEL_LEFT", VariantAdapter(Vector3(1, 0, 0)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "MODEL_RIGHT", VariantAdapter(Vector3(-1, 0, 0)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "MODEL_TOP", VariantAdapter(Vector3(0, 1, 0)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "MODEL_BOTTOM", VariantAdapter(Vector3(0, -1, 0)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "MODEL_FRONT", VariantAdapter(Vector3(0, 0, 1)), JS_PROP_ENUMERABLE);
	JS_DefinePropertyValueStr(ctx, ctor, "MODEL_REAR", VariantAdapter(Vector3(0, 0, -1)), JS_PROP_ENUMERABLE);
}

static int js_vector3_class_init(JSContext *ctx) {
	classes["Vector3"] = 0;
	classes["Vector3"] = JS_NewClassID(&classes["Vector3"]);
	JSClassID class_id = classes["Vector3"];
	...
	define_vector3_constants(ctx, ctor);

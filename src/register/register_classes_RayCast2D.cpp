...
void register_classes_RayCast2D() {
    ...
    _module.class_<RayCast2D>("RayCast2D")
            .constructor<>()
            .base<Node2D>()
            .property<static_cast<bool(RayCast2D::*)()const>(&RayCast2D::is_enabled),static_cast<void(RayCast2D::*)(bool)>(&RayCast2D::set_enabled)>("enabled")
            .property<static_cast<bool(RayCast2D::*)()const>(&RayCast2D::get_exclude_parent_body),static_cast<void(RayCast2D::*)(bool)>(&RayCast2D::set_exclude_parent_body)>("exclude_parent")
            .property<static_cast<Vector2(RayCast2D::*)()const>(&RayCast2D::get_target_position),static_cast<void(RayCast2D::*)(const Vector2 &)>(&RayCast2D::set_target_position)>("target_position")
            .property<static_cast<uint32_t(RayCast2D::*)()const>(&RayCast2D::get_collision_mask),static_cast<void(RayCast2D::*)(uint32_t)>(&RayCast2D::set_collision_mask)>("collision_mask")
            .property<static_cast<bool(RayCast2D::*)()const>(&RayCast2D::is_hit_from_inside_enabled),static_cast<void(RayCast2D::*)(bool)>(&RayCast2D::set_hit_from_inside)>("hit_from_inside")
            .property<static_cast<bool(RayCast2D::*)()const>(&RayCast2D::is_collide_with_areas_enabled),static_cast<void(RayCast2D::*)(bool)>(&RayCast2D::set_collide_with_areas)>("collide_with_areas")
            .property<static_cast<bool(RayCast2D::*)()const>(&RayCast2D::is_collide_with_bodies_enabled),static_cast<void(RayCast2D::*)(bool)>(&RayCast2D::set_collide_with_bodies)>("collide_with_bodies")

...
void register_classes_GPUParticlesAttractorBox3D() {
	...
	_module.class_<GPUParticlesAttractorBox3D>("GPUParticlesAttractorBox3D")
			...
			.property<static_cast<Vector3 (GPUParticlesAttractorBox3D::*)() const>(&GPUParticlesAttractorBox3D::get_size), static_cast<void (GPUParticlesAttractorBox3D::*)(const Vector3 &)>(&GPUParticlesAttractorBox3D::set_size)>((new std::string("size"))->c_str());
}
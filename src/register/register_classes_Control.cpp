...
void register_classes_Control() {
    ...
    _module.class_<Control>("Control")
           ...
           .property<Control::_get_layout_mode, Control::_set_layout_mode>("layout_mode")
           .property<Control::_get_anchors_layout_preset, Control::_set_anchors_layout_preset>("anchors_preset")
           .property<Control::get_anchor, Control::_set_anchor>("anchor_left")
           .property<Control::get_anchor, Control::_set_anchor>("anchor_top")
           .property<Control::get_anchor, Control::_set_anchor>("anchor_right")
           .property<Control::get_anchor, Control::_set_anchor>("anchor_bottom")
           ...
           .property<Control::get_size, Control::_set_size>("size")
           .property<Control::get_position, Control::_set_position>("position")
           .property<Control::get_global_position, Control::_set_global_position>("global_position")

...
void register_classes_EditorExportPlugin() {
    ...
    _module.class_<EditorExportPlugin>("EditorExportPlugin")
            ...
            .fun<static_cast<Dictionary(EditorExportPlugin::*)(const Ref<EditorExportPlatform> &)const>(&EditorExportPlugin::_get_export_options_overrides)>("_get_export_options_overrides")

...
void register_singletons_NavigationServer2D() {
	...
	js_singleton.add((new std::string("map_get_path"))->c_str(), [singleton](const RID &map, const Vector2 &origin, const Vector2 &destination, bool optimize, uint32_t navigation_layers) -> PackedVector2Array { return singleton->map_get_path(map, origin, destination, optimize, navigation_layers); });
	js_singleton.add((new std::string("map_get_closest_point"))->c_str(), [singleton](const RID &map, const Vector2 &to_point) -> Vector2 { return singleton->map_get_closest_point(map, to_point); });
	js_singleton.add((new std::string("map_get_closest_point_owner"))->c_str(), [singleton](const RID &map, const Vector2 &to_point) -> RID { return singleton->map_get_closest_point_owner(map, to_point); });
	...
	js_singleton.add((new std::string("map_get_random_point"))->c_str(), [singleton](const RID &map, uint32_t navigation_layers, bool uniformly) -> Vector2 { return singleton->map_get_random_point(map, navigation_layers, uniformly); });
	js_singleton.add((new std::string("query_path"))->c_str(), [singleton](const Ref<NavigationPathQueryParameters2D> &parameters, const Ref<NavigationPathQueryResult2D> &result) -> void { singleton->query_path(parameters, result); });
	...
	js_singleton.add((new std::string("region_owns_point"))->c_str(), [singleton](const RID &region, const Vector2 &point) -> bool { return singleton->region_owns_point(region, point); });
	...
	js_singleton.add((new std::string("region_set_transform"))->c_str(), [singleton](const RID &region, const Transform2D &transform) -> void { singleton->region_set_transform(region, transform); });
	js_singleton.add((new std::string("region_get_transform"))->c_str(), [singleton](const RID &region) -> Transform2D { return singleton->region_get_transform(region); });
	js_singleton.add((new std::string("region_set_navigation_polygon"))->c_str(), [singleton](const RID &region, const Ref<NavigationPolygon> &navigation_polygon) -> void { singleton->region_set_navigation_polygon(region, navigation_polygon); });
	...
	js_singleton.add((new std::string("region_get_connection_pathway_start"))->c_str(), [singleton](const RID &region, int32_t connection) -> Vector2 { return singleton->region_get_connection_pathway_start(region, connection); });
	js_singleton.add((new std::string("region_get_connection_pathway_end"))->c_str(), [singleton](const RID &region, int32_t connection) -> Vector2 { return singleton->region_get_connection_pathway_end(region, connection); });
	js_singleton.add((new std::string("region_get_random_point"))->c_str(), [singleton](const RID &region, uint32_t navigation_layers, bool uniformly) -> Vector2 { return singleton->region_get_random_point(region, navigation_layers, uniformly); });
	...
	js_singleton.add((new std::string("link_set_start_position"))->c_str(), [singleton](const RID &link, const Vector2 &position) -> void { singleton->link_set_start_position(link, position); });
	js_singleton.add((new std::string("link_get_start_position"))->c_str(), [singleton](const RID &link) -> Vector2 { return singleton->link_get_start_position(link); });
	js_singleton.add((new std::string("link_set_end_position"))->c_str(), [singleton](const RID &link, const Vector2 &position) -> void { singleton->link_set_end_position(link, position); });
	js_singleton.add((new std::string("link_get_end_position"))->c_str(), [singleton](const RID &link) -> Vector2 { return singleton->link_get_end_position(link); });
	...
	js_singleton.add((new std::string("agent_set_velocity_forced"))->c_str(), [singleton](const RID &agent, const Vector2 &velocity) -> void { singleton->agent_set_velocity_forced(agent, velocity); });
	js_singleton.add((new std::string("agent_set_velocity"))->c_str(), [singleton](const RID &agent, const Vector2 &velocity) -> void { singleton->agent_set_velocity(agent, velocity); });
	js_singleton.add((new std::string("agent_get_velocity"))->c_str(), [singleton](const RID &agent) -> Vector2 { return singleton->agent_get_velocity(agent); });
	js_singleton.add((new std::string("agent_set_position"))->c_str(), [singleton](const RID &agent, const Vector2 &position) -> void { singleton->agent_set_position(agent, position); });
	js_singleton.add((new std::string("agent_get_position"))->c_str(), [singleton](const RID &agent) -> Vector2 { return singleton->agent_get_position(agent); });
	...
	js_singleton.add((new std::string("obstacle_set_velocity"))->c_str(), [singleton](const RID &obstacle, const Vector2 &velocity) -> void { singleton->obstacle_set_velocity(obstacle, velocity); });
	js_singleton.add((new std::string("obstacle_get_velocity"))->c_str(), [singleton](const RID &obstacle) -> Vector2 { return singleton->obstacle_get_velocity(obstacle); });
	js_singleton.add((new std::string("obstacle_set_position"))->c_str(), [singleton](const RID &obstacle, const Vector2 &position) -> void { singleton->obstacle_set_position(obstacle, position); });
	js_singleton.add((new std::string("obstacle_get_position"))->c_str(), [singleton](const RID &obstacle) -> Vector2 { return singleton->obstacle_get_position(obstacle); });
	js_singleton.add((new std::string("obstacle_set_vertices"))->c_str(), [singleton](const RID &obstacle, const PackedVector2Array &vertices) -> void { singleton->obstacle_set_vertices(obstacle, vertices); });
	js_singleton.add((new std::string("obstacle_get_vertices"))->c_str(), [singleton](const RID &obstacle) -> PackedVector2Array { return singleton->obstacle_get_vertices(obstacle); });
	...
	js_singleton.add((new std::string("parse_source_geometry_data"))->c_str(), [singleton](const Ref<NavigationPolygon> &navigation_polygon, const Ref<NavigationMeshSourceGeometryData2D> &source_geometry_data, Node *root_node, const Callable &callback) -> void { singleton->parse_source_geometry_data(navigation_polygon, source_geometry_data, root_node, callback); });
	js_singleton.add((new std::string("bake_from_source_geometry_data"))->c_str(), [singleton](const Ref<NavigationPolygon> &navigation_polygon, const Ref<NavigationMeshSourceGeometryData2D> &source_geometry_data, const Callable &callback) -> void { singleton->bake_from_source_geometry_data(navigation_polygon, source_geometry_data, callback); });
	js_singleton.add((new std::string("bake_from_source_geometry_data_async"))->c_str(), [singleton](const Ref<NavigationPolygon> &navigation_polygon, const Ref<NavigationMeshSourceGeometryData2D> &source_geometry_data, const Callable &callback) -> void { singleton->bake_from_source_geometry_data_async(navigation_polygon, source_geometry_data, callback); });
	js_singleton.add((new std::string("is_baking_navigation_polygon"))->c_str(), [singleton](const Ref<NavigationPolygon> &navigation_polygon) -> bool { return singleton->is_baking_navigation_polygon(navigation_polygon); });
	...
	js_singleton.add((new std::string("simplify_path"))->c_str(), [singleton](const PackedVector2Array &path, double epsilon) -> PackedVector2Array { return singleton->simplify_path(path, epsilon); });
	...
	context->global()[(new std::string("NavigationServer2D"))->c_str()] = js_singleton;
}
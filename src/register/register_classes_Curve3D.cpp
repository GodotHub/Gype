...
void register_classes_Curve3D() {
    ...
    _module.class_<Curve3D>("Curve3D")
            .constructor<>()
            .base<Resource>()
            .property<static_cast<double(Curve3D::*)()const>(&Curve3D::get_bake_interval),static_cast<void(Curve3D::*)(double)>(&Curve3D::set_bake_interval)>("bake_interval")
            .property<static_cast<int32_t(Curve3D::*)()const>(&Curve3D::get_point_count),static_cast<void(Curve3D::*)(int32_t)>(&Curve3D::set_point_count)>("point_count")
            .property<static_cast<bool(Curve3D::*)()const>(&Curve3D::is_up_vector_enabled),static_cast<void(Curve3D::*)(bool)>(&Curve3D::set_up_vector_enabled)>("up_vector_enabled")

...
void register_classes_EditorPlugin() {
    ...
    _module.class_<EditorPlugin>("EditorPlugin")
            ...
            .fun<static_cast<Button *(EditorPlugin::*)(Control *,const String &,const Ref<Shortcut> &)>(&EditorPlugin::add_control_to_bottom_panel)>("add_control_to_bottom_panel")
            .fun<static_cast<void(EditorPlugin::*)(EditorPlugin::DockSlot,Control *,const Ref<Shortcut> &)>(&EditorPlugin::add_control_to_dock)>("add_control_to_dock")
            ...
            .fun<static_cast<void(EditorPlugin::*)(Control *,const Ref<Texture2D> &)>(&EditorPlugin::set_dock_tab_icon)>("set_dock_tab_icon")
...
;    qjs::Value _CustomControlContainer = context->newObject();
    _CustomControlContainer["CONTAINER_TOOLBAR"] = EditorPlugin::CustomControlContainer::CONTAINER_TOOLBAR;
    _CustomControlContainer["CONTAINER_SPATIAL_EDITOR_MENU"] = EditorPlugin::CustomControlContainer::CONTAINER_SPATIAL_EDITOR_MENU;
    _CustomControlContainer["CONTAINER_SPATIAL_EDITOR_SIDE_LEFT"] = EditorPlugin::CustomControlContainer::CONTAINER_SPATIAL_EDITOR_SIDE_LEFT;
    _CustomControlContainer["CONTAINER_SPATIAL_EDITOR_SIDE_RIGHT"] = EditorPlugin::CustomControlContainer::CONTAINER_SPATIAL_EDITOR_SIDE_RIGHT;
    _CustomControlContainer["CONTAINER_SPATIAL_EDITOR_BOTTOM"] = EditorPlugin::CustomControlContainer::CONTAINER_SPATIAL_EDITOR_BOTTOM;
    _CustomControlContainer["CONTAINER_CANVAS_EDITOR_MENU"] = EditorPlugin::CustomControlContainer::CONTAINER_CANVAS_EDITOR_MENU;
    _CustomControlContainer["CONTAINER_CANVAS_EDITOR_SIDE_LEFT"] = EditorPlugin::CustomControlContainer::CONTAINER_CANVAS_EDITOR_SIDE_LEFT;
    _CustomControlContainer["CONTAINER_CANVAS_EDITOR_SIDE_RIGHT"] = EditorPlugin::CustomControlContainer::CONTAINER_CANVAS_EDITOR_SIDE_RIGHT;
    _CustomControlContainer["CONTAINER_CANVAS_EDITOR_BOTTOM"] = EditorPlugin::CustomControlContainer::CONTAINER_CANVAS_EDITOR_BOTTOM;
    _CustomControlContainer["CONTAINER_INSPECTOR_BOTTOM"] = EditorPlugin::CustomControlContainer::CONTAINER_INSPECTOR_BOTTOM;
    _CustomControlContainer["CONTAINER_PROJECT_SETTING_TAB_LEFT"] = EditorPlugin::CustomControlContainer::CONTAINER_PROJECT_SETTING_TAB_LEFT;
    _CustomControlContainer["CONTAINER_PROJECT_SETTING_TAB_RIGHT"] = EditorPlugin::CustomControlContainer::CONTAINER_PROJECT_SETTING_TAB_RIGHT;
    _module.add("CustomControlContainer", std::move(_CustomControlContainer));
    qjs::Value _DockSlot = context->newObject();
    _DockSlot["DOCK_SLOT_LEFT_UL"] = EditorPlugin::DockSlot::DOCK_SLOT_LEFT_UL;
    _DockSlot["DOCK_SLOT_LEFT_BL"] = EditorPlugin::DockSlot::DOCK_SLOT_LEFT_BL;
    _DockSlot["DOCK_SLOT_LEFT_UR"] = EditorPlugin::DockSlot::DOCK_SLOT_LEFT_UR;
    _DockSlot["DOCK_SLOT_LEFT_BR"] = EditorPlugin::DockSlot::DOCK_SLOT_LEFT_BR;
    _DockSlot["DOCK_SLOT_RIGHT_UL"] = EditorPlugin::DockSlot::DOCK_SLOT_RIGHT_UL;
    _DockSlot["DOCK_SLOT_RIGHT_BL"] = EditorPlugin::DockSlot::DOCK_SLOT_RIGHT_BL;
    _DockSlot["DOCK_SLOT_RIGHT_UR"] = EditorPlugin::DockSlot::DOCK_SLOT_RIGHT_UR;
    _DockSlot["DOCK_SLOT_RIGHT_BR"] = EditorPlugin::DockSlot::DOCK_SLOT_RIGHT_BR;
    _DockSlot["DOCK_SLOT_MAX"] = EditorPlugin::DockSlot::DOCK_SLOT_MAX;
    _module.add("DockSlot", std::move(_DockSlot));
    qjs::Value _AfterGUIInput = context->newObject();
    _AfterGUIInput["AFTER_GUI_INPUT_PASS"] = EditorPlugin::AfterGUIInput::AFTER_GUI_INPUT_PASS;
    _AfterGUIInput["AFTER_GUI_INPUT_STOP"] = EditorPlugin::AfterGUIInput::AFTER_GUI_INPUT_STOP;
    _AfterGUIInput["AFTER_GUI_INPUT_CUSTOM"] = EditorPlugin::AfterGUIInput::AFTER_GUI_INPUT_CUSTOM;

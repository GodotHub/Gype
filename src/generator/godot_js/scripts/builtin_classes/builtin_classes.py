...
from scripts.utils.jinja_utils import variant_types, add_opaque, norm_op_name, to_js_type, camel_to_snake, get_module_path, is_variant, is_pod_type, add_prefix_suffix, get_type_index
import os
...
def render_builtin_classes(precision):
    ...
    env.globals['get_type_index'] = get_type_index

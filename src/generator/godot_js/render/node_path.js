...
export class NodePath {
  ...
  constructor (from) {
    if (!from) {
      ...
      _call_builtin_constructor(NodePath._bindings.constructor_2, this.opaque, [
  ...
  static _init_bindings () {
    ...
    }
    {
      ...
      this._bindings.method_get_concatenated_names = variant_get_ptr_builtin_method(
        GDExtensionVariantType.GDEXTENSION_VARIANT_TYPE_NODE_PATH,
        _gde_name.opaque,
        1825232092
      )
    }
    {
      ...
      this._bindings.method_get_concatenated_subnames = variant_get_ptr_builtin_method(
        GDExtensionVariantType.GDEXTENSION_VARIANT_TYPE_NODE_PATH,
        _gde_name.opaque,
        1825232092
      )
    ...
    }
    {
      ...
      this._bindings.method_get_as_property_path = variant_get_ptr_builtin_method(
        GDExtensionVariantType.GDEXTENSION_VARIANT_TYPE_NODE_PATH,
        _gde_name.opaque,
        1598598043
      )

...
export class PackedInt64Array {
  ...
  size () {
    ...
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_size,
      this,
      2,
      []
    )
  ...
  is_empty () {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_is_empty,
      this,
      1,
      []
    )
  ...
  set (_index, _value) {
    _call_builtin_method_ptr_no_ret(
      PackedInt64Array.#_bindings.method_set,
      this,
      [_index, _value]
    )
  }
  push_back (_value) {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_push_back,
      this,
      1,
      [_value]
    )
  ...
  append (_value) {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_append,
      this,
      1,
      [_value]
    )
  ...
  append_array (_array) {
    _call_builtin_method_ptr_no_ret(
      PackedInt64Array.#_bindings.method_append_array,
      this,
      [_array]
    )
  }
  remove_at (_index) {
    _call_builtin_method_ptr_no_ret(
      PackedInt64Array.#_bindings.method_remove_at,
      this,
      [_index]
    )
  }
  insert (_at_index, _value) {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_insert,
      this,
      2,
      [_at_index, _value]
    )
  ...
  fill (_value) {
    _call_builtin_method_ptr_no_ret(
      PackedInt64Array.#_bindings.method_fill,
      this,
      [_value]
    )
  }
  resize (_new_size) {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_resize,
      this,
      2,
      [_new_size]
    )
  ...
  clear () {
    _call_builtin_method_ptr_no_ret(
      PackedInt64Array.#_bindings.method_clear,
      this,
      []
    )
  }
  has (_value) {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_has,
      this,
      1,
      [_value]
    )
  ...
  reverse () {
    _call_builtin_method_ptr_no_ret(
      PackedInt64Array.#_bindings.method_reverse,
      this,
      []
    )
  }
  slice (_begin, _end) {
    ...
    ret.opaque = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_slice,
      this,
      31,
      [_begin, _end]
    )
  ...
  to_byte_array () {
    ...
    ret.opaque = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_to_byte_array,
      this,
      29,
      []
    )
  ...
  sort () {
    _call_builtin_method_ptr_no_ret(
      PackedInt64Array.#_bindings.method_sort,
      this,
      []
    )
  }
  bsearch (_value, _before) {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_bsearch,
      this,
      2,
      [_value, _before]
    )
  ...
  duplicate () {
    let ret = new PackedInt64Array()
    ret.opaque = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_duplicate,
      this,
      31,
      []
    )
  ...
  find (_value, _from) {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_find,
      this,
      2,
      [_value, _from]
    )
  ...
  rfind (_value, _from) {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_rfind,
      this,
      2,
      [_value, _from]
    )
  ...
  count (_value) {
    let ret
    ret = _call_builtin_method_ptr_ret(
      PackedInt64Array.#_bindings.method_count,
      this,
      2,
      [_value]
    )

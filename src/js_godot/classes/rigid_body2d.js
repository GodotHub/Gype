...
export class RigidBody2D extends PhysicsBody2D{
  ...
  static init_method_set_continuous_collision_detection_mode() {
    if (!this.#_bindings.method_set_continuous_collision_detection_mode) {
      let classname = new StringName("RigidBody2D");
  ...
  static init_method_get_continuous_collision_detection_mode() {
    if (!this.#_bindings.method_get_continuous_collision_detection_mode) {
      let classname = new StringName("RigidBody2D");
  ...
  set_mass(_mass) {
    RigidBody2D.init_method_set_mass();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_mass,
      this._owner,
      _mass
    );
  ...
  get_mass() {
    RigidBody2D.init_method_get_mass();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_mass,
      this._owner,
			Variant.Type.FLOAT,
  ...
  get_inertia() {
    RigidBody2D.init_method_get_inertia();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_inertia,
      this._owner,
			Variant.Type.FLOAT,
  ...
  set_inertia(_inertia) {
    RigidBody2D.init_method_set_inertia();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_inertia,
      this._owner,
      _inertia
    );
  ...
  set_center_of_mass_mode(_mode) {
    RigidBody2D.init_method_set_center_of_mass_mode();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_center_of_mass_mode,
      this._owner,
      _mode
    );
  ...
  get_center_of_mass_mode() {
    RigidBody2D.init_method_get_center_of_mass_mode();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_center_of_mass_mode,
      this._owner,
			Variant.Type.INT,
  ...
  set_center_of_mass(_center_of_mass) {
    RigidBody2D.init_method_set_center_of_mass();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_center_of_mass,
      this._owner,
      _center_of_mass
    );
  ...
  get_center_of_mass() {
    RigidBody2D.init_method_get_center_of_mass();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_center_of_mass,
      this._owner,
  ...
  set_physics_material_override(_physics_material_override) {
    RigidBody2D.init_method_set_physics_material_override();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_physics_material_override,
      this._owner,
  ...
  get_physics_material_override() {
    RigidBody2D.init_method_get_physics_material_override();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_physics_material_override,
      this._owner,
			Variant.Type.OBJECT,
  ...
  set_gravity_scale(_gravity_scale) {
    RigidBody2D.init_method_set_gravity_scale();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_gravity_scale,
      this._owner,
      _gravity_scale
    );
  ...
  get_gravity_scale() {
    RigidBody2D.init_method_get_gravity_scale();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_gravity_scale,
      this._owner,
			Variant.Type.FLOAT,
  ...
  set_linear_damp_mode(_linear_damp_mode) {
    RigidBody2D.init_method_set_linear_damp_mode();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_linear_damp_mode,
      this._owner,
      _linear_damp_mode
    );
  ...
  get_linear_damp_mode() {
    RigidBody2D.init_method_get_linear_damp_mode();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_linear_damp_mode,
      this._owner,
			Variant.Type.INT,
  ...
  set_angular_damp_mode(_angular_damp_mode) {
    RigidBody2D.init_method_set_angular_damp_mode();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_angular_damp_mode,
      this._owner,
      _angular_damp_mode
    );
  ...
  get_angular_damp_mode() {
    RigidBody2D.init_method_get_angular_damp_mode();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_angular_damp_mode,
      this._owner,
			Variant.Type.INT,
  ...
  set_linear_damp(_linear_damp) {
    RigidBody2D.init_method_set_linear_damp();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_linear_damp,
      this._owner,
      _linear_damp
    );
  ...
  get_linear_damp() {
    RigidBody2D.init_method_get_linear_damp();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_linear_damp,
      this._owner,
			Variant.Type.FLOAT,
  ...
  set_angular_damp(_angular_damp) {
    RigidBody2D.init_method_set_angular_damp();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_angular_damp,
      this._owner,
      _angular_damp
    );
  ...
  get_angular_damp() {
    RigidBody2D.init_method_get_angular_damp();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_angular_damp,
      this._owner,
			Variant.Type.FLOAT,
  ...
  set_linear_velocity(_linear_velocity) {
    RigidBody2D.init_method_set_linear_velocity();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_linear_velocity,
      this._owner,
      _linear_velocity
    );
  ...
  get_linear_velocity() {
    RigidBody2D.init_method_get_linear_velocity();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_linear_velocity,
      this._owner,
			Variant.Type.VECTOR2,
  ...
  set_angular_velocity(_angular_velocity) {
    RigidBody2D.init_method_set_angular_velocity();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_angular_velocity,
      this._owner,
      _angular_velocity
    );
  ...
  get_angular_velocity() {
    RigidBody2D.init_method_get_angular_velocity();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_angular_velocity,
      this._owner,
			Variant.Type.FLOAT,
  ...
  set_max_contacts_reported(_amount) {
    RigidBody2D.init_method_set_max_contacts_reported();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_max_contacts_reported,
      this._owner,
      _amount
    );
  ...
  get_max_contacts_reported() {
    RigidBody2D.init_method_get_max_contacts_reported();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_max_contacts_reported,
      this._owner,
			Variant.Type.INT,
  ...
  get_contact_count() {
    RigidBody2D.init_method_get_contact_count();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_contact_count,
      this._owner,
			Variant.Type.INT,
  ...
  set_use_custom_integrator(_enable) {
    RigidBody2D.init_method_set_use_custom_integrator();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_use_custom_integrator,
      this._owner,
      _enable
    );
  ...
  is_using_custom_integrator() {
    RigidBody2D.init_method_is_using_custom_integrator();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_is_using_custom_integrator,
      this._owner,
			Variant.Type.BOOL,
  ...
  set_contact_monitor(_enabled) {
    RigidBody2D.init_method_set_contact_monitor();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_contact_monitor,
      this._owner,
      _enabled
    );
  ...
  is_contact_monitor_enabled() {
    RigidBody2D.init_method_is_contact_monitor_enabled();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_is_contact_monitor_enabled,
      this._owner,
			Variant.Type.BOOL,
  ...
  set_continuous_collision_detection_mode(_mode) {
    RigidBody2D.init_method_set_continuous_collision_detection_mode();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_continuous_collision_detection_mode,
      this._owner,
      _mode
    );
  ...
  get_continuous_collision_detection_mode() {
    RigidBody2D.init_method_get_continuous_collision_detection_mode();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_continuous_collision_detection_mode,
      this._owner,
			Variant.Type.INT,
  ...
  set_axis_velocity(_axis_velocity) {
    RigidBody2D.init_method_set_axis_velocity();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_axis_velocity,
      this._owner,
      _axis_velocity
    );
  ...
  apply_central_impulse(_impulse) {
    RigidBody2D.init_method_apply_central_impulse();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_apply_central_impulse,
      this._owner,
      _impulse
    );
  ...
  apply_impulse(_impulse, _position) {
    RigidBody2D.init_method_apply_impulse();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_apply_impulse,
      this._owner,
      _impulse, _position
    );
  ...
  apply_torque_impulse(_torque) {
    RigidBody2D.init_method_apply_torque_impulse();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_apply_torque_impulse,
      this._owner,
      _torque
    );
  ...
  apply_central_force(_force) {
    RigidBody2D.init_method_apply_central_force();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_apply_central_force,
      this._owner,
      _force
    );
  ...
  apply_force(_force, _position) {
    RigidBody2D.init_method_apply_force();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_apply_force,
      this._owner,
      _force, _position
    );
  ...
  apply_torque(_torque) {
    RigidBody2D.init_method_apply_torque();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_apply_torque,
      this._owner,
      _torque
    );
  ...
  add_constant_central_force(_force) {
    RigidBody2D.init_method_add_constant_central_force();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_add_constant_central_force,
      this._owner,
      _force
    );
  ...
  add_constant_force(_force, _position) {
    RigidBody2D.init_method_add_constant_force();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_add_constant_force,
      this._owner,
      _force, _position
    );
  ...
  add_constant_torque(_torque) {
    RigidBody2D.init_method_add_constant_torque();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_add_constant_torque,
      this._owner,
      _torque
    );
  ...
  set_constant_force(_force) {
    RigidBody2D.init_method_set_constant_force();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_constant_force,
      this._owner,
      _force
    );
  ...
  get_constant_force() {
    RigidBody2D.init_method_get_constant_force();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_constant_force,
      this._owner,
			Variant.Type.VECTOR2,
  ...
  set_constant_torque(_torque) {
    RigidBody2D.init_method_set_constant_torque();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_constant_torque,
      this._owner,
      _torque
    );
  ...
  get_constant_torque() {
    RigidBody2D.init_method_get_constant_torque();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_constant_torque,
      this._owner,
			Variant.Type.FLOAT,
  ...
  set_sleeping(_sleeping) {
    RigidBody2D.init_method_set_sleeping();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_sleeping,
      this._owner,
      _sleeping
    );
  ...
  is_sleeping() {
    RigidBody2D.init_method_is_sleeping();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_is_sleeping,
      this._owner,
			Variant.Type.BOOL,
  ...
  set_can_sleep(_able_to_sleep) {
    RigidBody2D.init_method_set_can_sleep();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_can_sleep,
      this._owner,
      _able_to_sleep
    );
  ...
  is_able_to_sleep() {
    RigidBody2D.init_method_is_able_to_sleep();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_is_able_to_sleep,
      this._owner,
			Variant.Type.BOOL,
  ...
  set_lock_rotation_enabled(_lock_rotation) {
    RigidBody2D.init_method_set_lock_rotation_enabled();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_lock_rotation_enabled,
      this._owner,
      _lock_rotation
    );
  ...
  is_lock_rotation_enabled() {
    RigidBody2D.init_method_is_lock_rotation_enabled();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_is_lock_rotation_enabled,
      this._owner,
			Variant.Type.BOOL,
  ...
  set_freeze_enabled(_freeze_mode) {
    RigidBody2D.init_method_set_freeze_enabled();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_freeze_enabled,
      this._owner,
      _freeze_mode
    );
  ...
  is_freeze_enabled() {
    RigidBody2D.init_method_is_freeze_enabled();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_is_freeze_enabled,
      this._owner,
			Variant.Type.BOOL,
  ...
  set_freeze_mode(_freeze_mode) {
    RigidBody2D.init_method_set_freeze_mode();
    return _call_native_mb_no_ret(
      RigidBody2D.#_bindings.method_set_freeze_mode,
      this._owner,
      _freeze_mode
    );
  ...
  get_freeze_mode() {
    RigidBody2D.init_method_get_freeze_mode();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_freeze_mode,
      this._owner,
			Variant.Type.INT,
  ...
  get_colliding_bodies() {
    RigidBody2D.init_method_get_colliding_bodies();
    return _call_native_mb_ret(
      RigidBody2D.#_bindings.method_get_colliding_bodies,
      this._owner,
			Variant.Type.ARRAY,

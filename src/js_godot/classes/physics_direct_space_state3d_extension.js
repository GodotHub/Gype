...
import { PhysicsDirectSpaceState3D } from 'src/js_godot/classesphysics_direct_space_state3d'
...
class _MethodBindings {
    ...
    method__rest_info;
    method__get_closest_point_to_object_volume;
...
export class PhysicsDirectSpaceState3DExtension extends PhysicsDirectSpaceState3D{
  ...
  static _init_bindings() {
    ...
    {
      let classname = new StringName("PhysicsDirectSpaceState3DExtension");
      let methodname = new StringName("_get_closest_point_to_object_volume");
      this._bindings.method__get_closest_point_to_object_volume = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
  ...
  _intersect_ray(_from, _to, _collision_mask, _collide_with_bodies, _collide_with_areas, _hit_from_inside, _hit_back_faces, _pick_ray, _result) {
    return _call_native_mb_ret(
      ...
      this._owner,
			Variant.Type.BOOL,
      _from, _to, _collision_mask, _collide_with_bodies, _collide_with_areas, _hit_from_inside, _hit_back_faces, _pick_ray, _result
    );
  }
  _intersect_point(_position, _collision_mask, _collide_with_bodies, _collide_with_areas, _results, _max_results) {
    return _call_native_mb_ret(
      ...
      this._owner,
			Variant.Type.INT,
      _position, _collision_mask, _collide_with_bodies, _collide_with_areas, _results, _max_results
    );
  }
  _intersect_shape(_shape_rid, _transform, _motion, _margin, _collision_mask, _collide_with_bodies, _collide_with_areas, _result_count, _max_results) {
    return _call_native_mb_ret(
      ...
      this._owner,
			Variant.Type.INT,
      _shape_rid, _transform, _motion, _margin, _collision_mask, _collide_with_bodies, _collide_with_areas, _result_count, _max_results
    );
  }
  _cast_motion(_shape_rid, _transform, _motion, _margin, _collision_mask, _collide_with_bodies, _collide_with_areas, _closest_safe, _closest_unsafe, _info) {
    return _call_native_mb_ret(
      ...
      this._owner,
			Variant.Type.BOOL,
      _shape_rid, _transform, _motion, _margin, _collision_mask, _collide_with_bodies, _collide_with_areas, _closest_safe, _closest_unsafe, _info
    );
  }
  ...
  _get_closest_point_to_object_volume(_object, _point) {
    return _call_native_mb_ret(
      ClassDB._bindings.method__get_closest_point_to_object_volume,
      this._owner,

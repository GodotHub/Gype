...
export class PrimitiveMesh extends Mesh{
  ...
  static _init_bindings() {
    {
      ...
      let methodname = new StringName("_create_mesh_array");
      this._bindings.method__create_mesh_array = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
  ...
  _create_mesh_array() {
    return _call_native_mb_ret(
      ClassDB._bindings.method__create_mesh_array,
      this._owner,
			Variant.Type.ARRAY
    ,

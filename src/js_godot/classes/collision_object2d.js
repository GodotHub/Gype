...
class _MethodBindings {
    ...
    method__mouse_enter;
    method__mouse_exit;
    method__mouse_shape_enter;
    method__mouse_shape_exit;
    method_get_rid;
...
export class CollisionObject2D extends Node2D{
  ...
  static _init_bindings() {
    ...
    {
      let classname = new StringName("CollisionObject2D");
      let methodname = new StringName("_mouse_shape_enter");
      this._bindings.method__mouse_shape_enter = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
    ...
    {
      let classname = new StringName("CollisionObject2D");
      let methodname = new StringName("_mouse_shape_exit");
      this._bindings.method__mouse_shape_exit = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
  ...
  _mouse_shape_enter(_shape_idx) {
    return _call_native_mb_no_ret(
      ClassDB._bindings.method__mouse_shape_enter,
      this._owner,
      _shape_idx
    );
  }
  _mouse_shape_exit(_shape_idx) {
    return _call_native_mb_no_ret(
      ClassDB._bindings.method__mouse_shape_exit,
      this._owner,
      _shape_idx
    );
  }

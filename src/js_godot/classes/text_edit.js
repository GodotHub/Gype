...
class _MethodBindings {
    method__handle_unicode_input;
    method__backspace;
    method__cut;
    method__copy;
    method__paste;
    method__paste_primary_clipboard;
    method_has_ime_text;
    method_cancel_ime;
    method_apply_ime;
    method_set_editable;
...
export class TextEdit extends Control{
  ...
  static _init_bindings() {
    {
      ...
      let methodname = new StringName("_handle_unicode_input");
      this._bindings.method__handle_unicode_input = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
    ...
    {
      let classname = new StringName("TextEdit");
      let methodname = new StringName("_backspace");
      this._bindings.method__backspace = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
    ...
    {
      let classname = new StringName("TextEdit");
      let methodname = new StringName("_cut");
      this._bindings.method__cut = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
    ...
    {
      let classname = new StringName("TextEdit");
      let methodname = new StringName("_copy");
      this._bindings.method__copy = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
    ...
    {
      let classname = new StringName("TextEdit");
      let methodname = new StringName("_paste");
      this._bindings.method__paste = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
    ...
    {
      let classname = new StringName("TextEdit");
      let methodname = new StringName("_paste_primary_clipboard");
      this._bindings.method__paste_primary_clipboard = internal.classdb_get_method_bind(
        classname.opaque, 
        methodname.opaque, 
  ...
  _handle_unicode_input(_unicode_char, _caret_index) {
    return _call_native_mb_no_ret(
      ClassDB._bindings.method__handle_unicode_input,
      this._owner,
      _unicode_char, _caret_index
    );
  }
  _backspace(_caret_index) {
    return _call_native_mb_no_ret(
      ClassDB._bindings.method__backspace,
      this._owner,
      _caret_index
    );
  }
  ...
  _copy(_caret_index) {
    return _call_native_mb_no_ret(
      ClassDB._bindings.method__copy,
      this._owner,
      _caret_index
    );
  }
  _paste(_caret_index) {
    return _call_native_mb_no_ret(
      ClassDB._bindings.method__paste,
      this._owner,
      _caret_index
    );
  }
  _paste_primary_clipboard(_caret_index) {
    return _call_native_mb_no_ret(
      ClassDB._bindings.method__paste_primary_clipboard,
      this._owner,
      _caret_index
    );
  }

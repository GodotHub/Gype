...
struct js_traits<godot::PackedVector2Array> {
	...
	static JSValue wrap(JSContext *ctx, godot::PackedVector2Array rid) noexcept {
		return Value{ ctx, std::forward<godot::PackedVector2Array>(rid) };
	}
};
template <>
struct js_traits<godot::PackedVector3Array> {
	...
	static JSValue wrap(JSContext *ctx, godot::PackedVector3Array rid) noexcept {
		return Value{ ctx, std::forward<godot::PackedVector3Array>(rid) };
	}
};
template <>
struct js_traits<godot::PackedColorArray> {
	...
	static JSValue wrap(JSContext *ctx, godot::PackedColorArray rid) noexcept {
		return Value{ ctx, std::forward<godot::PackedColorArray>(rid) };
	}
};

...
static Variant js_call_internal(void *opaque, const Variant **p_args, GDExtensionInt p_arg_count) {
	...
	static GDExtensionPtrBuiltInMethod method_call = internal::gdextension_interface_variant_get_ptr_builtin_method(GDEXTENSION_VARIANT_TYPE_SIGNAL, _gde_name._native_ptr(), 3643564216);
	Variant ret;
...
static void js_call_deferred_internal(void *opaque, const Variant **p_args, GDExtensionInt p_arg_count) {
	...
	static GDExtensionPtrBuiltInMethod method_call_deferred = internal::gdextension_interface_variant_get_ptr_builtin_method(GDEXTENSION_VARIANT_TYPE_SIGNAL, _gde_name._native_ptr(), 3286317445);
...
static void js_rpc_internal(void *opaque, const Variant **p_args, GDExtensionInt p_arg_count) {
	...
	static GDExtensionPtrBuiltInMethod method_rpc = internal::gdextension_interface_variant_get_ptr_builtin_method(GDEXTENSION_VARIANT_TYPE_SIGNAL, _gde_name._native_ptr(), 3286317445);
...
static void js_rpc_id_internal(void *opaque, const Variant **p_args, GDExtensionInt p_arg_count) {
	...
	static GDExtensionPtrBuiltInMethod method_rpc_id = internal::gdextension_interface_variant_get_ptr_builtin_method(GDEXTENSION_VARIANT_TYPE_SIGNAL, _gde_name._native_ptr(), 2270047679);
...
static Callable js_bind_internal(void *opaque, const Variant **p_args, GDExtensionInt p_arg_count) {
	...
	static GDExtensionPtrBuiltInMethod method_bind = internal::gdextension_interface_variant_get_ptr_builtin_method(GDEXTENSION_VARIANT_TYPE_SIGNAL, _gde_name._native_ptr(), 3224143119);
	Callable ret;
